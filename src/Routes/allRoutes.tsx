...
const authProtectedRoutes = [
  ...
  // {
  //   path: "/apps-ecommerce-product-grid",
  ...
  // },
  // {
  //   path: "/apps-ecommerce-order-overview",
  ...
  // {
  //   path: "/apps-ecommerce-seller-overview",
  //   name: "Ecommerce Sellers Overview",
  ...
  //Learning
  // {
  //   path: "/apps-learning-list",
  //   name: "CourseListview",
  //   component: <CourseListview />,
  // },
  // {
  //   path: "/apps-learning-overview",
  //   name: "Overview",
  //   component: <Overview />,
  // },
  // { path: "/apps-learning-grid", name: "Gridview", component: <Gridview /> },
  // {
  //   path: "/apps-learning-category",
  //   name: "Category",
  //   component: <Category />,
  // },
  // {
  //   path: "/apps-learning-create",
  //   name: "CreateCourse",
  //   component: <CreateCourse />,
  // },
  // {
  //   path: "/apps-student-courses",
  //   name: "MyCourses",
  //   component: <MyCourses />,
  // },
  // {
  //   path: "/apps-student-subscriptions",
  //   name: "MySubsciptions",
  //   component: <MySubsciptions />,
  // },

  // {
  //   path: "/apps-instructors-list",
  //   name: "ListViewInstructor",
  //   component: <ListViewInstructor />,
  // },
  // {
  //   path: "/apps-instructors-create",
  //   name: "CreateInstructor",
  //   component: <CreateInstructor />,
  // },
  // {
  //   path: "/apps-instructors-grid",
  //   name: "GridViewInstructor",
  //   component: <GridViewInstructor />,
  // },
  // {
  //   path: "/apps-instructors-overview",
  ...
  // },
  // {
  //   path: "/apps-real-estate-list",
  //   name: "ListingList",
  //   component: <ListingList />,
  // },
  // {
  //   path: "/apps-real-estate-map",
  //   name: "ListingMap",
  //   component: <ListingMap />,
  // },
  // {
  //   path: "/apps-real-estate-agent-list-view",
  //   name: "AgentList",
  //   component: <AgentList />,
  // },
  // {
  ...
  // },
  // {
  //   path: "/apps-real-estate-agent-overview",
  //   name: "AgentOverview",
  //   component: <AgentOverview />,
  // },
  // {
  //   path: "/apps-real-estate-agencies-list-view",
  //   name: "AgenciesList",
  //   component: <AgenciesList />,
  // },
  // {
  //   path: "/apps-real-estate-agencies-overview",
  //   name: "AgenciesOverview",
  ...
  // },
  // {
  //   path: "/apps-real-estate-earning",
  //   name: "EstateEarning",
  //   component: <EstateEarning />,
  // },
  ...
  {
    path: "/ui-accordions",
    name: "AccordianCollapse",
    component: <AccordianCollapse />,
  },
