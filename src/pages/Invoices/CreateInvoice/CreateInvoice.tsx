...
const CreateInvoice = () => {
  document.title = "Create Invoice List | Ramana - Admin & Dashboard Template";
                  ...
                  <Card.Body className="z-1 position-relative">
                      ...
                      <Col lg={4}>
                        <div className="mx-auto mb-3">
                          <input
                            ...
                            type="file"
                            className="logo-img-file-input d-none"
                          />
                          <label
                            htmlFor="logo-img-file-input"
                            className="d-block"
                            tabIndex={0}
                          >
                            <span
                            ...
                            >
                              <img
                                src={logoLight}
                                className="card-logo card-logo-image img-fluid"
                                alt="logo light"
                              />
                            </span>
                          </label>
                    ...
                    <div className="mt-4">
                      <Row className="g-3">
                        ...
                        <Col lg={3} sm={6}>
                          <div>
                            <Form.Label htmlFor="due-date-field">
                              Date
                            </Form.Label>
                            <Flatpickr
                              name="date"
                            ...
                            <Col lg={6}>
                              ...
                              <div className="mb-2">
                                <Form.Control
                                  ...
                                  value={
                                    validation.values.shipping_address || ""
                                  }
                                  onBlur={validation.handleBlur}
                                  onChange={validation.handleChange}
                                  placeholder="Address"
                    ...
                    <div>
                      <div className="pt-2">
                        <Form.Control
                          ...
                          defaultValue="Congratulations on your recent purchase! It has been our pleasure to serve you, and we hope we see you again soon."
                          required
                        />
                      </div>
