...
const OverviewInvoice = () => {
  document.title = "Invoice Overview | Ramana - Admin & Dashboard Template";
                ...
                <Card.Body className="z-1 position-relative">
                  ...
                  <div className="mt-4 pt-2">
                    <Row className="g-3">
                      <div className="col-6">
                        ...
                        <h6 className="fs-md" id="billing-name">
                          Jennifer Mayert
                        </h6>
                        <p
                      ...
                      <div className="col-6">
                        ...
                        <h6 className="fs-md" id="shipping-name">
                          Jennifer Mayert
                        </h6>
                        <p
                          className="text-muted mb-1"
                  ...
                  <div>
                    <p className="mb-4 pb-2">
                      <b>Congratulations on your recent purchase!</b> It has
                      been our pleasure to serve you, and we hope we see you
                      again soon.
                    </p>
