...
const OrderOverview = () => {
  document.title = "Orders  Overview | Ramana - Admin & Dashboard Template";
              ...
              <Card>
                <Card.Body className="d-flex align-items-center flex-wrap gap-3">
                  ...
                  <div className="flex-shrink-0">
                    <Button href={"/apps-invoices-overview"} variant="primary">
            ...
            <Col lg={12}>
              <Card>
                <Card.Header className="d-flex align-items-center flex-wrap gap-2">
                  <Card.Title className="flex-grow-1 mb-0" as="h6">
                    Order Status
                  </Card.Title>
                ...
                <Card.Body>
                  <div className="progress progress-step-arrow progress-info mb-4">
                    <a
                      ...
                      style={{ width: "100%" }}
                    >
                      <i className="ph-bag align-baseline me-1 d-none d-lg-inline-block"></i>{" "}
                      Order Placed
                    </a>
                    <a
                      href="#progressbar"
                      className="progress-bar active d-none d-xxl-inline-block"
                      role="progressbar"
                      style={{ width: "100%" }}
                    >
                      <i className="ph-package align-middle me-1"></i> Packed
                    </a>
                    <a
                      href="#progressbar"
                      className="progress-bar pending d-none d-md-inline-block"
                      role="progressbar"
                      style={{ width: "100%" }}
                    >
                      <i className="ph-truck align-baseline me-1 d-none d-lg-inline-block"></i>{" "}
                      Shipping
                    </a>
                    <a
                      href="#progressbar"
                      className="progress-bar d-none d-md-inline-block"
                      role="progressbar"
                      style={{ width: "100%" }}
                    >
                      <i className="ph-bicycle align-baseline me-1 d-none d-lg-inline-block"></i>{" "}
                      Out For Delivery
                    </a>
                    <a
                      href="#progressbar"
                      ...
                      style={{ width: "100%" }}
                    >
                      <i className="ph-house-line align-baseline me-1 d-none d-lg-inline-block"></i>{" "}
                      Delivered
                    </a>
                  </div>
                  <div
