...
const Customers = () => {
  document.title = "Customers | Ramana - Admin & Dashboard Template";
                    ...
                    <div>
                      <div className="d-flex flex-wrap gap-2">
                        ...
                        <Button variant="secondary">
                          <i className="ph-cloud-arrow-down align-middle me-1"></i>{" "}
                          Import
                        </Button>
                        <Button variant="subtle-info">
                          <i className="ph-cloud-arrow-up align-middle me-1"></i>{" "}
                          Export
                        </Button>
                      </div>
                    </div>
        ...
        >
          <Modal.Body>
            ...
            <div className="mb-3">
              ...
              <PatternFormat
                ...
                onChange={formik.handleChange}
              />
              {formik.errors.customercontact &&
              formik.touched.customercontact ? (
          ...
          <Modal.Footer style={{ display: "block" }}>
            <div className="hstack gap-2 justify-content-end">
              ...
              <Button variant="success" type="submit" id="add-btn">
                Add Customer
              </Button>
            </div>
          </Modal.Footer>
