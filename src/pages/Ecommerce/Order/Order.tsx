...
const Order = () => {
  document.title = "Orders | Ramana - Admin & Dashboard Template";
    ...
    () => [
      {
        ...
        Cell: (cell: any) => {
          return <Form.Check.Input type="checkbox" className="orderCheckBox" />;
        },
        id: "#",
        Filter: false,
        isSortable: false,
      ...
      },
      {
        ...
        isSortable: true,
        Cell: (cell: any) => {
          const date = moment(cell.row.original.orderdate).format(
            "DD MMM ,YYYY"
          );
          return <span className="order_date">{date}</span>;
        },
      },
      {
      ...
      },
      {
        ...
        isSortable: true,
        Cell: (cell: any) => {
          return <span className="products">{cell.row.original.product}</span>;
        },
      },
      {
        Header: "Customers",
        ...
        isSortable: true,
        Cell: (cell: any) => {
          return <span className="customer">{cell.row.original.customer}</span>;
        },
      },
      {
        Header: "Shop",
          ...
          return (
            <Link to="#" className="text-reset">
              <img
                ...
                alt=""
                className="avatar-xxs rounded-circle me-1 shop-logo"
              />
              <span className="shop-name">{cell.row.original.name}</span>
            </Link>
          );
        },
      },
      ...
      },
      {
        ...
        isSortable: true,
        Cell: (cell: any) => {
          return <span className="fw-medium">${cell.row.original.price}</span>;
        },
      },
      {
        Header: "Rating",
        ...
        Cell: (cell: any) => {
          return (
            <h5 className="fs-md fw-medium mb-0">
              {cell.row.original.ratings}
            </h5>
          );
        },
      },
          ...
          <Row className="row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
            {(order || [])?.map((item: any) => {
              return (
                <Col key={item.id}>
                  <Card
                    className={`border-bottom border-3 card-animate border-${item.border}`}
                  >
                    <Card.Body>
                      <Badge
                        className={`bg-${item.color}-subtle text-${item.color} float-end`}
                      >
                        <i className={`${item.icone} align-middle me-1`}></i>
                        {item.rat}
                      </Badge>
                      <h4 className="mb-4">
                        ...
                        <Dropdown style={{ cursor: "pointer" }}>
                          ...
                          <Dropdown.Menu className="dropdown-menu-end">
                            ...
                            <Dropdown.Item
                              href="#"
                              className="sort"
                              onClick={() => handleData("deliverystatus")}
                            >
                              Status
                            </Dropdown.Item>
                          </Dropdown.Menu>
        ...
        >
          <Modal.Body>
            ...
            <div className="mb-3">
              ...
              >
                ...
                <option value="Jeans blue men boxer">
                  Jeans blue men boxer
                </option>
          ...
          <Modal.Footer>
            <div className="hstack gap-2 justify-content-end">
              <Button variant="light" onClick={handleAddOrderClose}>
                {" "}
                Close{" "}
              </Button>
