...
const PortfolioOverview = () => {
  ...
  const handlesearchdata = (event: any) => {
    ...
    if (search) {
      ...
      setProductTable(
        sellerOverview.filter((data: any) =>
    ...
    () => [
      {
        ...
        Cell: (cell: any) => {
          return (
            <Form.Check.Input type="checkbox" className="orderCheckBox " />
          );
        },
        id: "#",
        Filter: false,
      ...
      },
      {
        ...
        Cell: (cell: any) => {
          return (
            <span>
              {cell.row.original.orders ? cell.row.original.orders : "--"}
            </span>
          );
        },
      },
                ...
                return (
                  <Col lg={3} md={6} key={item.id}>
                    <Card.Body className="text-center border-end-md border-bottom-lg-0 border-bottom">
                      <h5 className={`mb-2 ${item.color || ""}`}>
                        <span className="counter-value">{item.num}</span>
                      </h5>
        ...
        <div id="productList">
          <Row className="g-3 justify-content-between mb-3">
            <Col lg={3}>
              <div className="search-box">
                <Form.Control
                  ...
                  onChange={(e: any) => handlesearchdata(e)}
                />
            ...
            <Col className="col-lg-auto">
              ...
              <Button type="button" className="add-btn" onClick={handleAddShow}>
          ...
          <Modal.Footer>
            <div className="hstack gap-2 justify-content-end">
              ...
              <Button type="submit" variant="primary" id="add-btn">
                {editshow ? "Edit product" : "Add product"}
              </Button>
            </div>
          </Modal.Footer>
        </Form>
