...
const BasicCenterEnd = () => {
  document.title = " Profile | Ramana Admin & Dashboard Template";
                  ...
                  <Card.Body>
                    <div className="mt-n5">
                      <Image
                        src={avatar1}
                        alt=""
                        className="avatar-lg rounded-circle p-1 bg-card-custom mt-n3"
                      />
                    </div>
                  </Card.Body>
                    ...
                    <Row className="justify-content-between gy-4">
                      <Col xl={5} md={7}>
                        ...
                        <div className="hstack gap-2">
                          ...
                          <Button
                            variant="soft-info"
                            className="btn-icon bg-info-subtle text-info"
                          >
                          ...
                          <Dropdown role="button">
                            <Dropdown.Toggle
                              as="a"
                              className="btn bg-danger-subtle text-danger btn-icon arrow-none"
                            >
                  ...
                  <Card.Body>
                    <div className="mt-n5 text-center">
                      <Image
                        src={avatar1}
                        alt=""
                        className="avatar-lg rounded-circle p-1 bg-card-custom mt-n3 mx-auto"
                      />
                    </div>
                  </Card.Body>
                  <Card.Body className="pt-0">
