...
const RatingRtr = () => {
  document.title = " Ratings | Ramana Admin & Dashboard Template";
            ...
            <Card>
              ...
              <Card.Body>
                <p className="text-muted">
                  Rater-js is a star rating widget for the browser. here are the
                  various examples of rating shown below with variation.
                </p>
