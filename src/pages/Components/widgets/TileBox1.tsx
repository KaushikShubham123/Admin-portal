...
import {
  ...
  Areachartmini9Colors,
  ImpressionsColors,
  SessionChartColors,
  ViewsChartColors,
  VisitDurationColors,
} from "./widgetAllCharts";

const TileBox1 = () => {
  document.title = "Widgets | Ramana - Admin & Dashboard Template";

  return (
    <React.Fragment>
      <div className="page">
        <BreadCrumb title="Widgets" pageTitle="Ramana" />
        <Row>
              ...
              <Card.Body>
                <Dropdown className="float-end">
                  <Dropdown.Toggle className="text-reset btn btn-light">
                    <span className="text-muted fs-lg">
                  ...
                  <Col lg={6}>
                    <h3 className="mb-4">
                      <span className="counter-value" data-target="40">
                        <CountUp end={368.24} separator="," />
                      </span>
                      k
                    </h3>
                    <p className="text-success mb-0">
                      <i className="bi bi-arrow-up me-1"></i> 06.41% Last Month
                    </p>
                  </Col>
                  <Col lg={6}>
                    <div
                      id="session_chart"
                      className="apex-charts m-n3 mt-n4"
                      dir="ltr"
                    >
              ...
              <Card.Body>
                ...
                <div className="row mt-4 align-items-end">
                  <Col lg={6}>
                    <h3 className="mb-4">
                      <span className="counter-value" data-target="40">
                        <CountUp end={1.47} separator="," />
                      </span>
                      sec{" "}
                    </h3>
                    <p className="text-success mb-0">
                      <i className="bi bi-arrow-up me-1"></i> 13% Last Month
                    </p>
                  </Col>
                  <Col lg={6}>
                    <div
                      id="visti_duration_chart"
                      className="apex-charts m-n3 mt-n4"
                      dir="ltr"
                    >
          ...
          <Col xl={3} sm={6}>
            <Card>
              <Card.Body>
                <Dropdown className="float-end">
                  <Dropdown.Toggle
                    className="text-reset btn btn-light"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                    <span className="text-muted fs-lg">
                ...
                <div className="row mt-4 align-items-end">
                  <Col lg={6}>
                    <h3 className="mb-4">
                      <span className="counter-value" data-target="40">
                        <CountUp end={1647} separator="," />
                      </span>
                    </h3>
                    <p className="text-danger mb-0">
                      <i className="bi bi-arrow-down me-1"></i> 07.26% Last Week
                    </p>
                  </Col>
                  <Col lg={6}>
                    <div
        ...
        <Row>
          <Col xl={3} sm={6}>
            <Card
              className="file-manager-widgets"
              style={{
                backgroundSize: "95px",
                  ...
                  <div className="flex-shrink-0">
                    <p>
                      <span className="text-success me-1">
                        <i className="ri-arrow-right-up-line fs-sm align-middle"></i>{" "}
                        +3.47 %
                      </span>{" "}
                      than last week
                    </p>
                  ...
                  <div className="flex-shrink-0">
                    <p>
                      <span className="text-danger me-1">
                        <i className="ri-arrow-right-down-line fs-sm align-middle"></i>{" "}
                        +6.33 %
                      </span>{" "}
                      than last week
                    </p>
          ...
          <Col xl={3} sm={6}>
            <Card
              className="card-primary file-manager-widgets"
              style={{
                backgroundSize: "95px",
                backgroundPosition: "right bottom",
              }}
            >
              <Card.Body>
                ...
                <h4 className="fw-semibold text-reset mb-3">
                  <span className="counter-value" data-target="40">
                    <CountUp end={365} separator="," />
                  </span>
                  k
                </h4>
                <p className="fw-medium text-white text-opacity-50 mb-0">
                  New Tickets
                </p>
              </Card.Body>
            </Card>
            ...
            <Card className=" overflow-hidden">
              <Card.Body>
                ...
                <h4>
                  $
                  <span className="counter-value" data-target="40">
                    <CountUp end={368.24} separator="," />0
                  </span>
                  M{" "}
                </h4>
                ...
                <p className="text-muted mb-0">
                  <span className="badge bg-success-subtle text-success">
                    <i className="bi bi-arrow-up"></i> 4.65%
                  </span>{" "}
                  vs last month
                </p>
              </Card.Body>
              <ProgressBar
                variant="primary"
                now={76}
                className="progress-sm rounded-0"
                style={{ width: "76%", height: "5px" }}
              />
            </Card>
          </Col>
          ...
          <div className="col-xxl col-sm-6">
            <Card className=" overflow-hidden">
              <Card.Body>
                ...
                <p className="text-muted mb-0">
                  <span className="badge bg-success-subtle text-success">
                    <i className="bi bi-arrow-up"></i> 1.33%
                  </span>{" "}
                  vs last month
                </p>
              </Card.Body>
          ...
          <div className="col-xxl col-sm-6">
            <Card className="overflow-hidden">
              <Card.Body>
                ...
                <p className="text-muted mb-0">
                  <span className="badge bg-success-subtle text-success">
                    <i className="bi bi-arrow-up"></i> 2.69%
                  </span>{" "}
                  vs last month
                </p>
              </Card.Body>
          ...
          <div className="col-xxl col-sm-6">
            <Card className="overflow-hidden">
              <Card.Body>
                ...
                <h4>
                  <span className="counter-value" data-target="40">
                    <CountUp end={648} separator="," />
                  </span>
                </h4>
                <p className="text-muted mb-4">Campaign Sent</p>
                <p className="text-muted mb-0">
                  <span className="badge bg-danger-subtle text-danger">
                    <i className="bi bi-arrow-down"></i> 0.78%
                  </span>{" "}
                  vs last month
                </p>
              </Card.Body>
          ...
          <div className="col-xxl">
            <Card className="overflow-hidden">
              <Card.Body>
                ...
                <h4>
                  <span className="counter-value" data-target="40">
                    <CountUp end={1742} separator="," />
                  </span>
                </h4>
                <p className="text-muted mb-4">Annual Deals</p>
                <p className="text-muted mb-0">
                  <span className="badge bg-success-subtle text-success">
                    <i className="bi bi-arrow-up"></i> 7.93%
                  </span>{" "}
                  vs last month
                </p>
              </Card.Body>
              ...
              <Row className=" g-4">
                <div className="col-xxl-3 col-md-6 border-end-md border-dashed">
                  <div className="text-center">
                    ...
                    <h5 className="mb-0">
                      2451{" "}
                      <small className="badge fs-2xs bg-danger-subtle text-danger ms-1">
                        <i className="ph-arrow-down align-baseline"></i> 1.02%
                      </small>
                    </h5>
                  </div>
                </div>
                <div className="col-xxl-3 col-md-6 border-end-xxl border-dashed">
                  <div className="text-center">
                    ...
                    <h5 className="mb-0">
                      $750.36M{" "}
                      <small className="badge fs-2xs bg-success-subtle text-success ms-1">
                        <i className="ph-arrow-up align-baseline"></i> 2.17%
                      </small>
                    </h5>
                  </div>
                </div>
                <div className="col-xxl-3 col-md-6 border-end-md border-dashed">
                  <div className="text-center">
                    ...
                    <h5 className="mb-0">
                      $750.36M{" "}
                      <small className="badge fs-2xs bg-success-subtle text-success ms-1">
                        <i className="ph-arrow-up align-baseline"></i> 07.26%
                      </small>
                    </h5>
                  </div>
                </div>
                <Col xxl={3} md={6}>
                  <div className="text-center">
                    ...
                    <h5 className="mb-0">
                      4689{" "}
                      <small className="badge fs-2xs bg-success-subtle text-success ms-1">
                        <i className="ph-arrow-up align-baseline"></i> 3.62%
                      </small>
                    </h5>
                  </div>
                </Col>
          ...
          <Row className=" row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
              ...
              <Card className="border-bottom border-3 card-animate border-primary">
                <Card.Body>
                  <span className="badge bg-success-subtle text-success float-end">
                    <i className="ph-trend-up align-middle me-1"></i> 3.8%
                  </span>
                  <h4 className="mb-4">
                    <span className="counter-value" data-target="40">
                      <CountUp end={21438} separator="," />0
                    </span>
                  </h4>
            ...
            <Col>
              <Card className="border-bottom border-3 card-animate card-secondary border-secondary">
                <Card.Body>
                  <span className="badge bg-success-subtle text-success float-end">
                    <i className="ph-trend-up align-middle me-1"></i> 20.8%
                  </span>
                  <h4 className="mb-4 text-reset">
                    <span className="counter-value" data-target="40">
                      <CountUp end={5963} separator="," />0
                    </span>
                  </h4>

                  <p className="text-white text-opacity-50 fw-medium text-uppercase mb-0">
                    New Orders
                  </p>
                </Card.Body>
              </Card>
            ...
            <Col>
              <Card className="border-bottom border-3 card-animate border-warning">
                <Card.Body>
                  <span className="badge bg-success-subtle text-success float-end">
                    <i className="ph-trend-up align-middle me-1"></i> 12.6%
                  </span>
                  <h4 className="mb-4">
                    <span className="counter-value" data-target="40">
                      <CountUp end={4620} separator="," />0
                    </span>
                  </h4>
            ...
            <Col>
              <Card className="border-bottom border-3 card-animate border-success">
                <Card.Body>
                  <span className="badge bg-success-subtle text-success float-end">
                    <i className="ph-trend-up align-middle me-1"></i> 18.7%
                  </span>
                  <h4 className="mb-4">
                    <span className="counter-value" data-target="40">
                      <CountUp end={8541} separator="," />0
                    </span>
                  </h4>
              ...
              <Card className="border-bottom border-3 card-animate border-danger">
                <Card.Body>
                  <span className="badge bg-danger-subtle text-danger float-end">
                    <i className="ph-trend-down align-middle me-1"></i> 7.1%
                  </span>
                  <h4 className="mb-4">
                    <span className="counter-value" data-target="40">
                      <CountUp end={2314} separator="," />0
                    </span>
                  </h4>
