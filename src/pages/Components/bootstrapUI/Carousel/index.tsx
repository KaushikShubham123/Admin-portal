...
const Carousel = () => {
  document.title = " Carousel | Ramana Admin & Dashboard Template";
          ...
          <Row>
              ...
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    ...
                    Note the presence of the <code>d-block</code> and{" "}
                    <code>w-100</code> class on carousel images to prevent
            ...
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>carousel-control-prev</code> and{" "}
                    <code>carousel-control-next</code> class with &lt;button&gt;
                    or &lt;a&gt; tag element to show carousel with control
                    navigation.
                  </p>
                  <ControlledSlide />
                </Card.Body>
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>carousel-indicators</code> class with &lt;ol&gt;
            ...
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>carousel-caption</code> class to add captions to
                    the carousel.
                  </p>
                  <Captions />
                </Card.Body>
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>carousel-fade</code> class to the carousel to
            ...
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>data-bs-interval=" "</code> to a carousel-item to
                    change the amount of time to delay between automatically
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Carousels support swiping left/right on touchscreen devices
                    to move between slides. This can be disabled using the{" "}
                    <code>data-bs-touch</code> attribute. The example below also
                    does not include the
                    <code>data-bs-ride attribute</code> and has{" "}
                    <code>data-bs-interval="false"</code> so it doesn’t
                    autoplay.
                  </p>
                  <DisableTouch />
                </Card.Body>
            ...
            <Col xl={6}>
              <Card>
                ...
                <Card.Body>
                  <p className="text-muted">
                    Use <code>carousel-dark</code> class to the carousel for
