          ...
          <Card>
            ...
            <Card.Body>
              <p className="text-muted">
                ...
                <code>offcanvas-bottom</code>, or <code>offcanvas-start</code>{" "}
                to offcanvas class to set different Offcanvas Placement.
              </p>
              <div>
                <div className="d-flex flex-wrap gap-2">
                  <Button onClick={toggleTopCanvas} variant="primary">
                    Toggle Top Offcanvas
                  </Button>
                  <Button onClick={toggleRightCanvas} variant="secondary">
                    Toggle Right Offcanvas
                  </Button>
                  <Button onClick={toggleBottomCanvas} variant="success">
                    Toggle Bottom Offcanvas
                  </Button>
                  <Button onClick={toggleLeftCanvas} variant="danger">
                          ...
                          <div className="box-content px-3 py-2">
                            <div className="gallery-overlay">
                              <h5 className="overlay-caption">
                                A mix of friends and strangers adventure.
                              </h5>
                            </div>
                      ...
                      <div className="acitivity-timeline p-4">
                        ...
                        <div className="acitivity-item py-3 d-flex">
                          ...
                          <div className="flex-grow-1 ms-3">
                            ...
                            <p className="text-muted mb-2">
                              added a new member to Ramana dashboard
                            </p>
