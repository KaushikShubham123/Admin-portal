...
} from "./UiAccordianCode";

const DefaultFlush = () => {
  document.title = " Accordions | Ramana - Admin & Dashboard Template";
  return (
    <React.Fragment>
      <div className="page">
              ...
              <Card.Body>
                ...
                <Accordion defaultActiveKey="0">
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      Although you probably won’t get into any legal trouble if
                      you do it just once, why risk it? If you made your
                      subscribers a promise, you should honor that. If not, you
                      run the risk of a drastic increase in opt outs, which will
                  ...
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                      No charges are put in place by SlickText when subscribers
                      join your text list. This does not mean however that
                      charges 100% will not occur. Charges that may occur fall
                      under part of the compliance statement stating "Message
                ...
                <Accordion className="accordion-flush" defaultActiveKey="0">
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      ...
                      anniversary of your original paid sign up date. Upgrading
                      in the middle of your billing period will not change the
                      billing date. Upgrading does however force an immediate,
                  ...
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                      ...
                      then upgraded to a paid plan at a later date, your bill
                      will renew based on the date you had upgraded to a paid
                      plan. All invoices are able to be viewed under your plan
                      options in your SlickText account.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body>
                      ...
                      practice, and further communication after they opt out
                      would be considered against compliance.
                    </Accordion.Body>
                  </Accordion.Item>
                </Accordion>
              </Card.Body>
