...
const RatioVideo = () => {
  document.title = " Embed Video | Ramana Admin & Dashboard Template";
  return (
    <React.Fragment>
      <div className="page">
        ...
        <Row>
          <Col xl={6}>
            <Card>
              ...
              <Card.Body>
                <p className="text-muted">
                  Wrap any embed in<code>&lt;iframe&gt;</code> tag, in a parent
                  element, use <code>ratio-16x9</code> class to set aspect ratio
                  16:9.{" "}
                </p>
                <div>
            ...
            <Card>
              ...
              <Card.Body>
                <p className="text-muted">
                  Use <code>--tb-aspect-ratio: 50%</code> to style element to
