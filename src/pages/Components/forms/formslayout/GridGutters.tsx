...
const GridGutters = () => {
  document.title = " Form layout | Ramana Admin & Dashboard Template";
              ...
              <Card.Body>
                ...
                <form action="#">
                  <Row>
                    ...
                    <Col md={12}>
                      <div className="mb-3">
                        <Form.Label htmlFor="compnayNameinput">
                          Company Name
                        </Form.Label>
                        <Form.Control
                          type="text"
                    ...
                    <Col md={6}>
                      <div className="mb-3">
                        <Form.Label htmlFor="emailidInput">
                          Email Address
                        </Form.Label>
                        <Form.Control
                          type="email"
                    ...
                    <Col md={12}>
                      <div className="mb-3">
                        <Form.Label htmlFor="address1ControlTextarea">
                          Address
                        </Form.Label>
                        <Form.Control
                          type="text"
                ...
                <Form action="#" className="row g-3">
                  ...
                  <Col md={6}>
                    ...
                    <Form.Control
                      type="email"
                      id="inputEmail4"
                      placeholder="admin@Themesdesign.com"
                    />
                  </Col>
                  <Col md={6}>
