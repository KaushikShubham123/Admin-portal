...
const DefaultSelects = () => {
  document.title = " Form Select | Ramana Admin & Dashboard Template";
            ...
            <Card>
              ...
              <Card.Body>
                <p className="text-muted">
                  Use <code>&lt;select&gt;</code> attribute with numerous
                  options to show value with choice's option.
                </p>
                <Row>
                  <Col lg={6}>
                    <Form.Select
                    ...
                    >
                      <option defaultValue="Select your Status">
                        Select your Status{" "}
                      </option>
                  ...
                  <Col lg={6}>
                    <Form.Select
                      ...
                      aria-label="Default select example"
                    >
                      <option defaultValue="Search for services">
                        Search for services
                      </option>
                  ...
                  <Col lg={6}>
                    <Form.Select aria-label="Disabled select example" disabled>
                      <option defaultValue="Open this select menu (Disabled)">
