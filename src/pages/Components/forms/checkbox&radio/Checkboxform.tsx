...
const Checkboxform = () => {
  document.title = " Checkboxs & Radios | Ramana Admin & Dashboard Template";
                  ...
                  <Col lg={4} md={6}>
                    <div>
                      ...
                      <p className="text-muted">
                        ...
                        checkbox and add <code>checked</code>attribute to set a
                  ...
                  <Col lg={4} md={6}>
                    <div className="mt-4 mt-md-0">
                      ...
                      <p className="text-muted">
                        ...
                        disabled and add <code>checked</code> attribute to set a
                        checkbox checked by default.
                      </p>
                      <div>
