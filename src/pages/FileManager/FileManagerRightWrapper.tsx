        ...
        <SimpleBar className="h-100">
          <Card.Header className="d-flex gap-2 align-items-center">
            <div>
              <Button
                size="sm"
                className="btn-icon btn-subtle-danger"
          ...
          <Card.Body>
            <div id="storageChart" className="e-charts shadow-none mt-n4">
              <StorageChart
                id="storageChart"
                dataColors='["--tb-secondary", "--tb-primary", "--tb-light","--tb-danger", "--tb-success"]'
              />
            </div>
              ...
              <li>
                ...
                >
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div className="flex-shrink-0 text-muted">2.5 MB</div>
                  </div>
                </Link>
              </li>
              <li>
                ...
                >
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div className="flex-shrink-0 text-muted">276 MB</div>
                  </div>
                </Link>
              </li>
              <li>
                ...
                >
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div className="flex-grow-1">
                      <h6 className="mb-0">Ramana Admin</h6>
                    </div>
                    <div className="flex-shrink-0 text-muted">631 MB</div>
                  </div>
                </Link>
              </li>
              <li>
                ...
                >
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div className="flex-shrink-0 text-muted">1.3 GB</div>
                  </div>
                </Link>
              </li>
              <li>
                ...
                >
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div className="flex-shrink-0 text-muted">698 MB</div>
                  </div>
                </Link>
              </li>
              <li>
                ...
                >
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div className="flex-grow-1">
                      <h6 className="mb-0">Ramana Docs</h6>
                    </div>
                    <div className="flex-shrink-0 text-muted">32.19 MB</div>
                  </div>
                </Link>
              </li>
              <li>
            ...
            <Card className="card-primary file-manager-widgets mb-0">
              <Card.Body>
                <p className="fs-md text-white text-opacity-75">
                  Invite 2 friends and get 5 GB extra space.
                </p>
                <Link
                  to="#"
                  className="stretched-link text-decoration-underline text-reset"
                >
                  Invite Friends{" "}
