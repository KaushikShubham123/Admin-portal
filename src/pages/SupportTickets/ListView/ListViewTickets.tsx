...
const ListViewTickets = () => {
  document.title = "Tickets | Ramana - Admin & Dashboard Template";
  ...
  const handleSearch = (event: any) => {
    ...
    if (search) {
      ...
      setListView(
        supportticketList.filter((data: any) =>
      ...
      },
      {
        ...
        accessor: (cell: any) => {
          switch (cell.priority) {
            case "Low":
              return <Badge bg="danger">{cell.priority}</Badge>;
            case "Medium":
              return <Badge bg="info">{cell.priority}</Badge>;
            default:
              return <Badge bg="success">{cell.priority}</Badge>;
          }
        },
      },
      {
            ...
            <ul className="d-flex gap-2 list-unstyled mb-0">
              ...
              <li>
                <Link
                  ...
                  onClick={() => handleEditTickets(cell)}
                >
  ...
  return (
    <React.Fragment>
                      ...
                      <div className="d-flex align-items-center mb-4">
                        <div className="flex-grow-1">
                          <div className="avatar-sm">
                            <div
                              className={`avatar-title bg-${item.imgBg}-subtle text-${item.imgBg} rounded fs-xl`}
                            >
                        ...
                        <div className="flex-shrink-0">
                          <p>
                            <span className={`text-${item.iconColor} me-1`}>
                              <i
                                className={`${item.icon} fs-sm align-middle`}
                              ></i>{" "}
                              +{item.num} %
                            </span>{" "}
                            than last week
      ...
      <Modal
        show={addTickets}
        onHide={handleCloseTickets}
        contentClassName="border-0"
      >
        <Modal.Header closeButton>
          <Modal.Title as="h5" id="addTicketModalLabel">
            {editTickets ? "Edit Ticket" : "Add Ticket"}
          </Modal.Title>
        </Modal.Header>
        <Form
        ...
        >
          <Modal.Body>
            <Row>
              <Col lg={12}>
                <div className="mb-3">
                  <Form.Label htmlFor="client-name-input">
                  ...
                  <div className="mx-n4 px-4 mb-3">
                    <div className="vstack gap-3 select-element">
                      {(assignesTickets || [])?.map((item: any) => {
                        return (
                          <div
                            className="d-flex align-items-center option-list"
                            key={item?.id}
                          >
              ...
              <Col lg={12}>
                <div className="mb-3">
                  <Form.Label htmlFor="ticket-title-input">
              ...
              <Col lg={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="create-date-input">
                    Create Date<span className="text-danger">*</span>
                  </Form.Label>
                  <Flatpickr
              ...
              <Col lg={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="due-date-input">
              ...
              <Col lg={12}>
                <div className="mb-3">
                  <Form.Label htmlFor="priority-input">
