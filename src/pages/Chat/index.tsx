...
const Chat = () => {
  document.title = "Chat | Ramana Admin & Dashboard Template";
          ...
          <div className="chat-wrapper d-lg-flex gap-1 p-1 mb-3">
            <Tab.Container defaultActiveKey="Chats">
              <div className="chat-wrapper-menu p-3 d-flex flex-column rounded">
                ...
                <Nav
                  as="ul"
                  className="chat-menu list-unstyled text-center nav nav-pills justify-content-center"
                >
                  <Nav.Item as="li">
                ...
                <Tab.Content>
                  <Tab.Pane eventKey="Chats" className="fade" id="pills-chats">
                    ...
                    <SimpleBar className="chat-room-list simplebar-scrollable-y simplebar-mouse-entered">
                        ...
                        >
                          {chatData.map((value: any, key: number) => (
                            <li
                              ...
                              className={
                                Chat_Box_Username === value.name ? "active" : ""
                              }
                            >
                              <Link
                                to="#"
                      ...
                      <div className="d-flex align-items-center px-4 mt-4 pt-4 mb-2">
                        <div className="flex-grow-1">
                          <h4 className="mb-0 fs-xs text-muted text-uppercase">
                            Channels
                          </h4>
                        </div>
                        <div className="flex-shrink-0">
                                              ...
                                              <div className="flex-shrink-0">
                                                <Dropdown className="cursor-pointer">
                                                  ...
                                                  <Dropdown.Menu className="dropdown-menu-end">
                                                    <Dropdown.Item>
                                                      <i className="bi bi-pencil text-muted me-2 align-bottom"></i>
                                                      Edit
                                                    </Dropdown.Item>
                                                    <Dropdown.Item>
                                                      <i className="bi bi-slash-circle text-muted me-2 align-bottom"></i>
                                                      Block
                                                    </Dropdown.Item>
                                                    <Dropdown.Item>
                                                      <i className="bi bi-trash3 text-muted me-2 align-bottom"></i>
                                                      Remove
                                                    </Dropdown.Item>
                                                  </Dropdown.Menu>
                                                </Dropdown>
                              ...
                              <div className="d-flex align-items-center">
                                ...
                                <div className="flex-shrink-0 ms-3">
                                  <div className="d-flex align-items-center gap-3">
                                    <div>
                                      <h5 className="mb-0 fs-xs text-muted">
                                        {value.time}
                                      </h5>
                                    </div>
                                    <div>
                                      <Button
                                        variant="link"
                                        className="btn-link p-0 fs-lg stretched-link"
                                      >
                            ...
                            <li key={key} className="m-4">
                              <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 overflow-hidden">
                                  ...
                                  <p className="text-muted text-truncate fs-xs mb-0">
                                    {value.size}
                                  </p>
                                </div>
                                ...
                                <div className="flex-shrink-0 ms-3">
                                  <Dropdown>
                                    <Dropdown.Toggle
                                      as="a"
                                      className="fs-md text-muted px-1"
                                    >
                                    ...
                                    <Dropdown.Menu className="dropdown-menu-end">
                                      ...
                                      >
                                        Open{" "}
                                        <i className="bi bi-file-earmark ms-2 text-muted"></i>
                                      </Dropdown.Item>
                                      <Dropdown.Item
                                        className="d-flex align-items-center justify-content-between"
                                        href="#"
                                      >
                                        Edit{" "}
                                        <i className="bi bi-pencil ms-2 text-muted"></i>
                                      </Dropdown.Item>
                                      ...
                                      >
                                        Delete{" "}
                                        <i className="bi bi-trash3 ms-2 text-muted"></i>
                                      </Dropdown.Item>
                                    </Dropdown.Menu>
                                  </Dropdown>
                                </div>
                  ...
                  >
                    <div>
                      ...
                      <SimpleBar
                        className="chat-bookmark-list px-4"
                        data-simplebar="init"
                      >
                        {attachementsData.map((value: any, key: number) => (
                          <Card className="p-2 border mb-2" key={key}>
                            ...
                            >
                              ...
                              <div className="flex-grow-1 overflow-hidden">
                                <h5 className="fs-sm fw-medium text-truncate mb-1">
                                  {value.foldername}
                                </h5>
                                ...
                                <div className="d-flex gap-2">
                                  ...
                                  <Dropdown>
                                    ...
                                    <Dropdown.Menu className="dropdown-menu-end">
                                      ...
                                      >
                                        Share{" "}
                                        <i className="bi bi-share ms-2 text-muted"></i>
                                      </Dropdown.Item>
                                      <Dropdown.Item
                                        className="d-flex align-items-center justify-content-between"
                                        href="#"
                                      >
                                        Bookmark{" "}
                                        <i className="bi bi-bookmarks text-muted ms-2"></i>
                                      </Dropdown.Item>
                                      <div className="dropdown-divider"></div>
                                      <Dropdown.Item
                                        className="d-flex align-items-center justify-content-between"
                  ...
                  <Row className="align-items-center justify-content-between flex-nowrap">
                    <Col sm={4} className="col">
                      <div className="d-flex align-items-center">
                        <div className="flex-shrink-0 d-block d-lg-none me-3">
                          <Link to="#" className="user-chat-remove fs-lg p-1">
                        ...
                        <div className="flex-grow-1 overflow-hidden">
                          <div className="d-flex align-items-center">
                            ...
                            <div className="flex-grow-1 overflow-hidden">
                              <h5 className="text-truncate mb-1 fs-lg">
                                <Link
                              ...
                              <p className="text-truncate text-muted fs-md mb-0 userStatus">
                    ...
                    <Col lg={4} className="col-auto">
                      <div className="text-end">
                        ...
                        >
                          <i className="bi bi-plus d-block d-sm-none"></i>{" "}
                    ...
                    <Row className="g-3">
                      <Col lg={9}>
                        <div className="position-relative">
                          ...
                          <div
                            className="btn-group position-absolute top-0 end-0 bg-white bg-opacity-50 p-1 m-3"
                            role="group"
                  ...
                  <Row className="align-items-center justify-content-between">
                    <Col lg={12}>
                      <div className="hstack gap-2 justify-content-center">
                        <Button className="btn-subtle-secondary fs-lg btn-icon rounded-circle">
                          <i className="ph-video-camera-slash"></i>
                        </Button>
                        <Button
                          variant="danger"
                          className="fs-lg btn-icon rounded-circle call-disconnect"
                        >
                          <i className="ph-phone-disconnect"></i>
                        </Button>
                        <Button className="btn-subtle-secondary fs-lg btn-icon rounded-circle">
                          <i className="ph-microphone-slash"></i>
                        </Button>
                      </div>
                    </Col>
                  </Row>
                  ...
                  <div className="position-relative">
                    ...
                    >
                            ...
                            <div className="d-flex align-items-center">
                              <div className="flex-shrink-0 d-block d-lg-none me-3">
                                <Link
                                  ...
                                  className="user-chat-remove fs-lg p-1"
                                >
                                  <i className="ri-arrow-left-s-line align-bottom"></i>
                                </Link>
                              </div>
                          ...
                          <Col sm={8} className="col-auto">
                            <ul className="list-inline user-chat-nav text-end mb-0">
                              <li className="list-inline-item m-0">
                                <Dropdown>
                                  <Dropdown.Toggle
                                    bsPrefix="btn-ghost-secondary btn-icon"
                                    type="button"
                                  >
                              ...
                              <li className="list-inline-item d-none d-lg-inline-block m-0">
                                <Button
                                  type="button"
                                  className="btn-ghost-secondary fs-lg btn-icon video-icon"
                                >
                              ...
                              <li className="list-inline-item d-none d-lg-inline-block m-0">
                                <Button
                                  type="button"
                                  className="btn-ghost-secondary fs-lg btn-icon"
                                  data-bs-toggle="offcanvas"
                      ...
                      >
                        ...
                        >
                          {messages &&
                            map(messages, (message: any, key: number) => (
                              <li
                                className={
                                      ...
                                      <Dropdown className="align-self-start message-box-drop">
                                        ...
                                        <Dropdown.Menu>
                                          <Dropdown.Item
                                            ...
                                            href="#"
                                          >
                                            <i className="bi bi-reply me-2 text-muted"></i>
                                            Reply
                                          </Dropdown.Item>
                                          <Dropdown.Item href="#">
                                            <i className="bi bi-share me-2 text-muted"></i>
                                            Forward
                                          </Dropdown.Item>
                                          <Dropdown.Item
                                          ...
                                          >
                                            <i className="bi bi-clipboard-check me-2 text-muted"></i>
                                            Copy
                                          </Dropdown.Item>
                                          <Dropdown.Item href="#">
                                            <i className="bi bi-bookmarks me-2 text-muted"></i>
                                            Bookmark
                                          </Dropdown.Item>
                                          <Dropdown.Item
                                          ...
                                          >
                                            <i className="bi bi-trash3 me-2 text-muted"></i>
                                            Delete
                                          </Dropdown.Item>
                                        </Dropdown.Menu>
                                      </Dropdown>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              <div className="flex-grow-1 overflow-hidden">
                                <div className="d-flex align-items-center">
                                  ...
                                  <div className="flex-grow-1 overflow-hidden">
                                    <h5 className="text-truncate mb-0 fs-lg">
                                      <Link
                                        className="text-reset username"
                                        data-bs-toggle="offcanvas"
                                        to="#userProfileCanvasExample"
                            ...
                            <div className="chat-input-links me-2">
                              <div className="links-list-item">
                                <Button
                                  variant="link"
                                  type="button"
                                  className="btn-link text-decoration-none emoji-btn"
                                  id="emoji-btn"
                          ...
                          <div className="replymessage-block mb-0 d-flex align-items-start">
                            ...
                            <div className="flex-shrink-0">
                              <Button
                                type="button"
                                id="close_toggle"
                                className="btn-sm btn-link mt-n2 me-n3 fs-lg"
                              >
