...
const Email = () => {
  document.title = "Email | Ramana Admin & Dashboard Template";
  ...
  const readAll = () => {
    if (document.querySelectorAll(".message-list li.unread").length === 0) {
      (
        document.getElementById("unreadConversations") as HTMLElement
      ).style.display = "block";
      setTimeout(function () {
        (
          document.getElementById("unreadConversations") as HTMLElement
    ...
    <React.Fragment>
          ...
          <div className="email-wrapper d-lg-flex gap-1 mx-n3 mt-n3 p-1">
            <div className="email-panel p-3 pt-4 d-none d-lg-flex flex-column">
              <div className="text-center">
                <Link
                  to="#!"
                  className="btn btn-icon btn-primary btn-sm fs-lg toggle-email-panel"
                >
              ...
              <div className="panel-list mt-3">
                ...
                <Link to={"/apps-chat"}>
                  <i className="bi bi-camera-video"></i> <span>Meet</span>
                </Link>
                <Link to="/apps-file-manager">
                  <i className="bi bi-database"></i> <span>Storage</span>
                </Link>
              </div>
                ...
                <Dropdown className="mail-user-dropdown">
                  <Dropdown.Toggle as="a" bsPrefix="d-inline-block">
                    <img
                      src={avatar1}
                      alt=""
                      className="avatar-xs rounded mail-profile-img"
                    />
                  </Dropdown.Toggle>
                      ...
                      <div className="d-flex gap-2 align-items-center">
                        <div className="flex-shrink-0">
                          <img
                            src={avatar1}
                            alt=""
                            className="avatar-xxs rounded-circle mail-user-img"
                          />
                        </div>
            ...
            >
              <div className="p-4 d-flex flex-column h-100">
                <div className="pb-3">
                  <Button
                    className="btn-subtle-primary w-100"
                    onClick={() => setComposeModal(true)}
                  >
                    <i className="bi bi-plus-lg me-1 align-baseline"></i>{" "}
                    Compose
                  </Button>
                </div>

                <SimpleBar
                  className="mx-n4 px-4 email-menu-sidebar-scroll simplebar-scrollable-y"
                  data-simplebar="init"
                >
                  <div className="mail-list mt-3">
                    ...
                    >
                      ...
                      <span className="badge bg-secondary-subtle text-secondary ms-auto  ">
                        5
                      </span>
                    </Link>
                    <Link
                  ...
                  <div>
                    <h5 className="fs-xs text-uppercase text-muted mt-4">
                      Labels
                    </h5>
                  ...
                  <div className="border-top border-top-dashed pt-3 mt-3">
                    <Link
                      to="#"
                      className="btn btn-icon btn-sm btn-subtle-info btn-rounded float-end"
                    >
                      <i className="bx bx-plus fs-lg"></i>
                    </Link>
                    <h5 className="fs-xs text-uppercase text-muted mb-4">
                      Chat
                    </h5>
                    ...
                    <div className="mt-2 vstack email-chat-list mx-n4">
                      {chatData.map((item: any, key: any) => (
                        ...
                        >
                          ...
                          >
                            <h5 className="fs-sm text-truncate mb-0 chatlist-user-name">
                              {item.name}
                            </h5>
                            <small className="fs-xs text-muted text-truncate mb-0">
                              {item.caption}
                            </small>
                          </div>
                        </Link>
                    ...
                    <div className="col-lg-auto">
                      <div className="d-flex gap-sm-1 email-topbar-link">
                        <Button
                          ...
                          className="btn-subtle-success btn-icon btn-sm fs-lg email-menu-btn d-block d-lg-none"
                        >
                    ...
                    <Row className="align-items-center mt-3 mb-2 d-flex">
                      <Col className="col">
                        <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link ms-1">
                          ...
                          >
                            <div className="hstack gap-sm-1 align-items-center flex-wrap">
                              ...
                              <div data-bs-toggle="tooltip">
                                <Button
                                  className="btn-ghost-secondary btn-icon btn-sm fs-lg"
                                  onClick={() => {
                                    setDeleteModal(true);
                                  }}
                                >
                          ...
                          <div
                            className="alert alert-warning alert-dismissible unreadConversations-alert px-4 fade show "
                              ...
                              >
                                <div className="col-mail col-mail-1">
                                  ...
                                  <Link
                                    to="#"
                                    type="button"
                                    className="btn avatar-xs p-0 favorite-btn fs-md"
                                  >
            ...
            <div className="email-detail-content">
              <div className="p-4 d-flex flex-column h-100">
                <div className="pb-4 border-bottom border-bottom-dashed">
                  <Row>
                    <Col>
                      <div className="">
                        <Button
                          className="btn-subtle-danger btn-icon btn-sm fs-lg close-btn-email"
                          id="close-btn-email"
                    ...
                    <Col className="col-auto">
                      <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                        ...
                        <Button
                          className="btn-ghost-secondary btn-icon btn-sm fs-lg remove-mail"
                          onClick={() => {
                            setDeleteModal(true);
                          }}
                        >
                ...
                <SimpleBar
                  className="mx-n4 px-4 email-detail-content-scroll"
                  data-simplebar="init"
                >
                  ...
                  <Accordion
                    defaultActiveKey="0"
                    className="accordion-flush accordion-arrow-none"
                  >
                        ...
                        >
                          <div className="d-flex align-items-center text-muted">
                            ...
                            <div className="flex-grow-1 overflow-hidden">
                              <h5 className="fs-md text-truncate email-user-name mb-0">
                                {emailinfo.name}
                              </h5>
                        ...
                        <Accordion.Body className="text-body px-0">
                          <div>
                            ...
                            <p>
                              ...
                              id lacinia diam. Sed aliquam in dui et porta. Sed
                              bibendum orci non tincidunt ultrices.
                            </p>
                            <p>Sincerly,</p>
                            ...
                            <div className="d-flex gap-3">
                              <div className="border rounded avatar-xl h-auto">
                                ...
                                <div className="py-2 text-center">
                                  <Link to="" className="d-block fw-semibold">
                                    Download
                                  </Link>
                                </div>
                              </div>
                      ...
                      <Accordion.Header>
                        ...
                        >
                          <div className="d-flex align-items-center text-muted">
                            ...
                            <div className="flex-grow-1 overflow-hidden">
                              <h5 className="fs-md text-truncate email-user-name-right mb-0">
                                Richard Marshall
                              </h5>
                              <div className="text-truncate fs-xs">
                        ...
                        <Row>
                          <Col>
                            <div className="btn-group" role="group">
                              <Button
                                className="btn-sm py-0 fs-lg btn-light"
                          ...
                          <Col className="col-auto">
                            <div className="btn-group">
                              ...
                              <Button
                                className="btn-sm btn-success dropdown-toggle dropdown-toggle-split"
          ...
          >
            <Card className="mb-0 overflow-hidden">
              <Card.Header className="align-items-center d-flex bg-primary text-white-50 p-3">
                <div className="flex-grow-1">
                  <h5 className="fs-md text-white profile-username">
                ...
                <div className="flex-shrink-0">
                  <div className="mt-n1">
                    <Button
                      type="button"
                      className="btn-link btn-icon btn-sm text-white fs-lg text-decoration-none rounded-circle bg-white bg-opacity-10"
      ...
      <Modal show={composeModal} onHide={() => setComposeModal(false)}>
        <Modal.Header className="p-3 bg-light" closeButton>
          <Modal.Title as="h5" id="composemodalTitle">
            New Message
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
              ...
              <div className="position-absolute top-0 end-0">
                <div className="d-flex">
                  <button
                    ...
                    type="button"
                    onClick={() => setCcCollapse(!ccCollapse)}
                  >
                    Cc
                  </button>
                  <button
                    className="btn btn-link text-reset fw-semibold px-2"
                    type="button"
                    onClick={() => setBccCollapse(!bccCollapse)}
                  >
                    Bcc
                  </button>
                </div>
