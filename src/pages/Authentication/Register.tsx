...
const Register = () => {
  document.title = " Register | Ramana Admin & Dashboard Template";
  ...
  useEffect(() => {
    if (success) {
      setTimeout(() => navigate("/auth-twostep"), 3000);
      setTimer(3);
    }
        ...
        <div className="card mb-0 border-0 shadow-none mb-0">
          <div className="card-body p-sm-5 m-lg-4">
            <div className="text-center mt-2">
              ...
              <p className="text-muted">Get your free Ramana account now</p>
            </div>
            <div className="p-2 mt-5">
              ...
              >
                ...
                <Form.Group className="mb-3">
                  ...
                  {validation.touched.mobile && validation.errors.mobile ? (
                    <Form.Control.Feedback type="invalid">
                      <div>{validation.errors.mobile}</div>
                    </Form.Control.Feedback>
                  ) : null}
                </Form.Group>
                ...
                <Form.Group className="mb-3">
                  ...
                  {validation.touched.userType && validation.errors.userType ? (
                    <Form.Control.Feedback type="invalid">
                      <div>{validation.errors.userType}</div>
                    </Form.Control.Feedback>
                  ) : null}
                </Form.Group>
                ...
                <Form.Group className="mb-4">
                  <p className="mb-0 fs-xs text-muted fst-italic">
                    By registering you agree to the Ramana{" "}
                    <a
