...
const ForgotPassword = (props: any) => {
  document.title = " Reset Password | Ramana Admin & Dashboard Template";
  ...
  //   // setLoader(false);
  // }, [dispatch, forgetSuccessMsg, forgetError, navigate]);
          ...
          <Card className="card mb-0 border-0 shadow-none mb-0">
            <Card.Body className="p-sm-5 m-lg-4">
              <div className="text-center mt-2">
                ...
                <p className="text-muted mb-4">Reset password with Ramana</p>
                <div className="pb-4">
              ...
              <div className="p-2">
                ...
                <Form
                  onSubmit={(e) => {
                    console.log("Forget password button was clicked");
                    e.preventDefault();
