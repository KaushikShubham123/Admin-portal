...
const UserProfile = () => {
  document.title = "User Profile | Ramana Admin & Dashboard Template";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumb title="Ramana" pageTitle="Accounts" />

          <Row>
            <Col lg="12">
              {error && error ? <Alert variant="danger">{error}</Alert> : null}
              {success ? (
                <Alert variant="success">Username Updated To {name}</Alert>
              ) : null}
