...
const TermsContions = () => {
  document.title = " Term & Conditions | Ramana - Admin & Dashboard Template";
  return (
    <React.Fragment>
              ...
              <Card className="overflow-hidden">
                ...
                <Card.Body>
                  ...
                  <p className="text-muted mb-2">
                    These Themesbrand Standard Terms and Conditions written on
                    this webpage shall manage your use of our website,
                    themesbrand accessible at{" "}
                    <a href="https://themesbrand.com">themesbrand.com</a>.
                  </p>
                  <p className="text-muted mb-2">
                  ...
                  <p className="text-muted mb-2">
                    ...
                    rights and materials contained in this Themesbrand.
                  </p>
                  <p className="text-muted">
                  ...
                  <p className="text-muted">
                    ...
                    Themesbrand express no representations or warranties, of any
