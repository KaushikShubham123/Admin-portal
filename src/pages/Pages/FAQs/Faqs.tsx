...
const Faqs = () => {
  document.title = "FAQs | Ramana - Admin & Dashboard Template";
                  ...
                  <Accordion defaultActiveKey="0">
                    <Accordion.Item eventKey="0">
                      ...
                      <Accordion.Body>
                        ...
                        It's a space where customers away from your
                        sales-focused landing pages and homepage.
                      </Accordion.Body>
                    </Accordion.Item>
                    <Accordion.Item eventKey="1">
                      ...
                      <Accordion.Body>
                        ...
                        <b>
                          your opportunity to communicate with the most
                          important visitors to your website
                        </b>{" "}
                    ...
                    <Accordion.Item eventKey="2">
                      ...
                      <Accordion.Body>
                        ...
                        on frequent questions or concerns; however, the format
                        is a useful means of organizing information, and text
                    ...
                    <Accordion.Item eventKey="3">
                      ...
                      <Accordion.Body>
                        ...
                        addresses their concerns public product documentation
                    ...
                    <Accordion.Item eventKey="5">
                      ...
                      <Accordion.Body>
                        The methodology I've found most successful, has been
                        introduced by prof Jeanne Liedtka from Darden Business
                        School and identifies four stages: What is?, What if?,
            ...
            <Card.Body>
              <Row>
                <Col xl={4}>
                  ...
                  <p className="text-muted">
                    Cybersecurity experts recommend changing your password every
                    three months. There may even be situations where you should
                    change your password immediately, especially if a
                    cybercriminal has access to your account.
                  </p>
                </Col>
                <Col xl={8}>
                  <Accordion defaultActiveKey="1">
                    <Accordion.Item eventKey="0">
                      ...
                      <Accordion.Body>
                        ...
                        European languages. It will be as simple their most
                        common words.
                      </Accordion.Body>
                    </Accordion.Item>
                    <Accordion.Item eventKey="1">
                      ...
                      <Accordion.Body>
                        ...
                        simple as Occidental; in fact, it will be Occidental. To
            ...
            <Card.Body>
              <Row>
                <Col xl={4}>
                  ...
                  <p className="text-muted">
                    Privacy is the right to control how your information is
                    ...
                    protection against hackers or cyber criminals.
                  </p>
                </Col>
                <Col xl={8}>
                  <Accordion defaultActiveKey="0">
