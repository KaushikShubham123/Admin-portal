...
const PrivacyPolicy = () => {
  document.title = "Privacy Policy | Ramana - Admin & Dashboard Template";
              ...
              <Card className="overflow-hidden">
                <div className="bg-primary pb-0">
                  <Card.Body className="text-center py-4">
                    <h4 className="fw-medium text-white mb-3">
                      Privacy Policy
                    </h4>
                    <p className="text-white text-opacity-75 mb-0">
                      To learn more about Privacy at themesbrand please visit
                      our{" "}
                      <a
                        href="#!"
                ...
                <Card.Body>
                  <h6 className="card-title mb-3">
                    <i className="bi bi-circle-square align-baseline me-1 text-info"></i>{" "}
                    Getting Stared with Ramana
                  </h6>
                  ...
                  <p className="text-muted mb-2">
                    ...
                    through email at <b>steex@themesbrand.com</b>
                  </p>
                  ...
                  <p className="text-muted mb-2">
                    Right to Privacy: Every individual has his own secrets,
                    talks, planning etc. which they don not want to show, tell
                    and discuss with others. So right to privacy plays a
                    important role in the freedom and liberty of a person and if
                    our fundamental right given under Article 21 of Indian
                    Constitution, 1950.
                  </p>
                  <p className="text-muted mb-2">
                    Security is about the safeguarding of data, whereas privacy
                    is about the safeguarding of user identity.
                  </p>
                  <p className="text-muted mb-2">
                  ...
                  <p className="text-muted mb-2">
                    The specific differences, however, are more complex, and
                    there can certainly be areas of overlap between the two.
                    Security refers to protection against the unauthorized
                    access of data.
                  </p>
                  <p className="text-muted mb-2">
                  ...
                  <p className="text-muted mb-2">
                    ...
                    make decisions about it every single day. It gives us a
                    space to be ourselves without judgement, allows us to think
                    freely without discrimination, and is an important element
                    of giving us control over who knows what about us.
                  </p>
                  <p className="text-muted mb-2">
