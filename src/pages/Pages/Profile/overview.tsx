        ...
        <Tab.Container id="left-tabs-example" defaultActiveKey="first">
          <Row className="align-items-center g-3 mb-1">
            <div className="col-md order-1">
              ...
              >
                <Nav.Item>
                  <Nav.Link eventKey="first" href="#overview-tab">
                    Overview
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="second" href="#activities">
                    Activities
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="third" href="#projects">
                    Projects
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="fourth" href="#friends">
                    Friends
                  </Nav.Link>
                </Nav.Item>
              </Nav>
            ...
            <div className="col-md-auto order-lg-2">
              <Link to="/pages-profile-settings" className="btn btn-primary">
          ...
          <Tab.Content>
                ...
                <Card.Body>
                    ...
                    <Row className=" profile-media g-3">
                        ...
                        <Row className=" g-3">
                          <Col lg={12}>
                            <img
                              src={learning}
                              alt=""
                              className="fixed-width w-100 rounded object-fit-cover"
                            />
                          </Col>
                          <Col lg={6}>
                            <img
                      ...
                      <Col lg={3}>
                        <img
                          src={realestate2}
                          alt=""
                          className="img-fluid rounded object-fit-cover h-100 object-fit-cover"
                        />
                      </Col>
                      <Col lg={2}>
                        <Row className=" g-3">
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-muted mb-2">
                      A <b>Web Developer</b> creates and designs different
                      websites for clients. They are responsible for their
                      aesthetic as well as their function. Professionals in this
                      field may also need to be able to ensure sites are
                      compatible with multiple types of media. Web Developers
                      need to have a firm understanding of programming and
                      graphical design. Having a strong resume that emphasizes
                      these attributes makes it significantly easier to get
                      hired as a Web Developer.
                    </p>
                    <p className="text-muted mb-0">
                      As a web designer, my objective is to make a positive
                      impact on clients, co-workers, and the Internet using my
                      skills and experience to design compelling and attractive
                      websites. Solving code problems. Editing & Design with
                      designing team in the company to build perfect web
                      designs.
                    </p>
                  </div>
                  <div className="mb-4">
                    <Row>
                      ...
                      <Col lg={6}>
                        <h5 className="card-title mb-3 mt-4 mt-lg-0">
                          Skills & Knowledge
                        </h5>
                        <div className="d-flex flex-wrap gap-2">
                    ...
                    <ul className="acitivity-timeline-2 list-unstyled mb-0">
                      <li>
                        ...
                        <div className="d-flex align-items-center mb-3 gap-3">
                          <p className="mb-0">
                            <i className="bi bi-calendar align-baseline me-1"></i>{" "}
                            2023 - Continue
                          </p>
                          <p className="mb-0">
                            <i className="bi bi-buildings align-baseline me-1"></i>{" "}
                            California State University
                          </p>
                        </div>
                        <p className="text-muted mb-0">
                          It is a 3-year post-graduate course. To pursue MCA,
                          you must be a graduate from a well-known university
                          after completing 10+2 with Mathematics as a subject to
                      ...
                      <li>
                        ...
                        <p className="text-muted mb-0">
                          BCA is a three-year degree course for people who wish
                          to dive into the world of programming language.
                        </p>
                      </li>
                    </ul>
                  </div>
                  ...
                  <ul className="acitivity-timeline-2 list-unstyled mb-0">
                    ...
                    <li>
                      ...
                      <p className="mb-0 text-muted">
                        Lunch time after which sleep just doesn't want to let go
                        of me. 🤝
                      </p>
                    </li>
                    <li>
                      ...
                      <p className="mb-0 text-muted">
                        Drink the magical chai, it will ward off sleep they
                        said. 🤷‍
                      </p>
                    </li>
                    <li>
                      ...
                      <Card.Body>
                        <div className="d-flex align-items-center mb-3">
                          <div className="flex-grow-1 me-3">
                            <div
                              className={`badge bg-${item.badgeClass}-subtle text-${item.textcolor}`}
                            >
                              {item.course}
                            </div>
                          </div>
                        ...
                        <p className="text-muted fs-sm text-truncate">
                          Last Update :{" "}
                          <span className="fw-semibold text-reset">
                            {item.time}
                          </span>
                        </p>
                        <h5 className="fs-xs">
                          Inprogress{" "}
                          <span className={`text-${item.datacolor} float-end`}>
                            {item.data}%
                          </span>
                        </h5>
                        <ProgressBar
              ...
              <Row className=" align-items-center justify-content-between text-center text-sm-start mb-3">
                <div className="col-sm">
                  <div className="text-muted">
                    Showing <span className="fw-semibold">9</span> of{" "}
                    <span className="fw-semibold">11</span> Results
                  </div>
                </div>
                <div className="col-sm-auto mt-3 mt-sm-0">
                  <div className="pagination-wrap hstack gap-2">
                    ...
                    <Pagination className=" listjs-pagination mb-0">
                      <li className="active">
                        <Link className="page" to="#" data-i="1" data-page="10">
                          1
                        </Link>
                      </li>
                      <li>
                        <Link className="page" to="#" data-i="2" data-page="10">
                          2
                        </Link>
                      </li>
                    </Pagination>
            ...
            <Tab.Pane eventKey="fourth" id="friends" className="mt-3">
              <div className="d-flex align-items-center mb-4">
                ...
                <div>
                  <Link to="pages-contacts.html" className="icon-link">
                      ...
                      <Card.Body>
                        ...
                        <div className="d-flex align-items-center">
                          <div className="flex-shrink-0 position-relative">
                            ...
                            />
                            <span className="position-absolute top-0 start-100 translate-middle badge border border-2 border-white rounded-circle bg-success p-1">
                        ...
                        <div className="d-flex gap-2 pt-4">
                          <Link
                            to="/pages-profile"
                            className="btn btn-subtle-secondary w-50"
                          >
                            <i className="bi bi-person align-baseline me-1"></i>{" "}
                            Profile
                          </Link>
                          <button
                            type="button"
                            className="btn btn-primary text-truncate w-50"
                          >
                            <i className="bi bi-chat-left-text align-baseline me-1"></i>{" "}
                            Contact Us
                          </button>
                        </div>
                      </Card.Body>
              ...
              <Row className=" align-items-center mb-3">
                <div className="col-sm">
                  <div className="text-muted text-center text-sm-start">
                    Showing <span className="fw-semibold">9</span> of{" "}
                    <span className="fw-semibold">13</span> Results
                  </div>
                </div>
                <Col sm="auto" className="mt-3 mt-sm-0">
                  <Pagination className="justify-content-center gap-2">
                    <Pagination.Prev disabled href="#">
                      {" "}
                      Previous
                    </Pagination.Prev>
