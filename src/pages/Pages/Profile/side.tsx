          ...
          <Card.Body>
            ...
            <div className="text-center border-bottom border-dashed pb-4">
              <img
                src={avatar1}
                alt=""
                className="avatar-lg rounded-circle p-1 img-thumbnail"
              />
              <div className="mt-3">
                <h5>
                  Richard Marshall{" "}
              ...
              <div className="d-flex gap-2 mt-4">
                ...
                >
                  {isToggled ? (
                    <span className="icon-off btn-dark text-light custom-toggle w-50">
                      <i className="bi bi-person-x align-baseline me-1"></i>{" "}
                      Unfollow
                    </span>
                  ) : (
                    <span className="icon-on btn-subtle-secondary custom-toggle w-50">
                      <i className="bi bi-person-plus align-baseline me-1"></i>{" "}
                      Follow
                    </span>
                  )}
                </Button>
                <Button className="btn btn-primary text-truncate w-50">
              ...
              <div className="vstack gap-3">
                <div className="d-flex gap-2 align-items-center position-relative">
                  ...
                  <div className="flex-shrink-0">
                    <a
                      href="#!"
                      className="icon-link icon-link-hover text-reset stretched-link fs-xl"
                      ...
                      >
                        {isToggled ? (
                          <span className="icon-on">
                            <i className="bx bx-user-check align-bottom fs-md"></i>
                          </span>
                        ) : (
                          <span className="icon-off">
                            <i className="bx bx-user-x align-bottom fs-md"></i>
                          </span>
                        )}
                      </Button>
                    </div>
