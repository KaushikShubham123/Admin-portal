...
const PricingOne = () => {
  document.title = "Pricing | Ramana - Admin & Dashboard Template";
              ...
              <Col xxl={4} lg={6} className="g-3" key={elem.id}>
                <Card className="pricing-box ribbon-box right">
                  ...
                  <Card.Body className="p-4">
                      ...
                      <ul className="ps-3 vstack gap-3">
                        ...
                        {(elem.mutetext || []).map((item: any) => (
                          <React.Fragment key={item.id}>
                            <li className={`${item.design} ${item.active1}`}>
                              {item.details1}
                            </li>
                            <li className={`${item.design} ${item.active1}`}>
                              <b>5</b> {item.details2}
                            ...
                            <li className={`${item.design1} ${item.active}`}>
                              {item.details5}
                            </li>
                            <li className={`${item.design1} ${item.active}`}>
                              {item.details6}
                    ...
                    <div className="mt-4">
                      <Button className={`btn-${elem.button} w-100`}>
                        {elem.value}
                      </Button>
                    </div>
                  </Card.Body>
