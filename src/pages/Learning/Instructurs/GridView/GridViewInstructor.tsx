...
const GridViewInstructor = () => {
  document.title = "Grid View | Ramana - Admin & Dashboard Template";
  ...
  const currentdata = useMemo(
    () => instructorgridList.slice(indexOfFirst, indexOfLast),
    [instructorgridList, indexOfFirst, indexOfLast]
  );
  ...
  const searchTeamMember = (ele: any) => {
    ...
    if (search) {
      ...
      setCurrentpages(
        instructorgridList.filter((data: any) =>
  ...
  for (
    let i = 1;
    i <= Math.ceil(instructorgridList.length / perPageData);
    i++
  ) {
    pageNumbers.push(i);
  }
  ...
  const jobPosition: any =
    id % 2 === 0 ? "Marketing & Management" : "React Development";
      ...
      <div className="page-content">
        <Container fluid>
              ...
              <Row className="align-items-center g-2">
                <Col lg={3} className="me-auto">
                  <h6 className="card-title mb-0">
                    Instructors List{" "}
                    <Badge bg="primary" className="ms-1 align-baseline">
                      1452
                    </Badge>
                  </h6>
                </Col>
                ...
                <Col className="col-lg-auto">
                  <div className="hstack gap-2">
                    <Button variant="secondary" onClick={() => tog_modal()}>
                      <i className="bi bi-plus-circle align-baseline me-1"></i>{" "}
                      Add Instructor
                    </Button>
                    <Link
                      to="/apps-instructors-grid"
                      className="btn btn-subtle-primary active btn-icon ms-auto"
                    >
                      <i className="bi bi-grid"></i>
                    </Link>
                    <Link
                      to="/apps-instructors-list"
          ...
          <Row className="row-cols-xxl-5">
            {(currentpages || []).map(
              (gridviewInstructorData: any, key: any) => (
                <Col key={key}>
                  <Card>
                    <Card.Body>
                      <div className="d-flex align-items-center">
                        <div className="form-check flex-grow-1">
                          {gridviewInstructorData.checked ? (
                            <input
                        ...
                        <div className="flex-shrink-0">
                          <Dropdown className="curser-pointer">
                            <Dropdown.Toggle
                              ...
                              className="btn btn-light btn-icon btn-sm arrow-none"
                            >
                            ...
                            <Dropdown.Menu className="dropdown-menu-end ">
                              <Dropdown.Item
                                className="edit-list"
                                onClick={() =>
                                  handleEditData(gridviewInstructorData)
                                }
                              >
                              ...
                              <Dropdown.Item
                                ...
                                onClick={() =>
                                  handleDeleteShow(gridviewInstructorData)
                                }
                              >
                      ...
                      <div className="text-center mt-4 mb-3">
                        <div className="position-relative d-inline-block">
                          <img
                            src={gridviewInstructorData.userImg?.preview}
                            alt=""
                        ...
                        <Link to="/apps-instructors-overview">
                          <h6 className="fs-md mt-4 mb-1">
                            {gridviewInstructorData.username}
                          </h6>
                        </Link>
                        <p className="text-muted fs-sm mb-0">
                          {gridviewInstructorData.jobPosition}
                        </p>
                      </div>
                      ...
                      <ul className="list-unstyled text-muted vstack gap-2 mb-0 overflow-hidden">
                        <li>
                          <Link
                            to="mailto:ayaan@steex.com"
                            className="text-reset d-block text-truncate"
                          >
                            <i className="bi bi-envelope align-baseline me-1"></i>{" "}
                            {gridviewInstructorData.email}
                          </Link>
                        </li>
                        <li>
                          <Link
                            to="tel:+(152) 15963 24785"
                            className="text-reset"
                          >
                            <i className="bi bi-telephone align-baseline me-1"></i>{" "}
                            {gridviewInstructorData.phone}
                          </Link>
                        </li>
                        <li>
                          <i className="ph ph-graduation-cap align-baseline me-1"></i>{" "}
                          {gridviewInstructorData.course} Courses
                        </li>
                      </ul>
                    </Card.Body>
                    <Card.Body className="border-top border-1 border-dashed d-flex align-items-center">
                      <div className="flex-grow-1">
                        <span className="badge bg-warning-subtle text-warning">
                          ...
                          {gridviewInstructorData.rating}{" "}
                        </span>
                      </div>
                      <div className="flex-shrink-0"></div>
                      <Link
                        to="/apps-instructors-overview"
          ...
          >
            <Modal.Header closeButton>
              <Modal.Title as="h5" id="exampleModalLabel">
                {instructorgrid ? "Edit Instructor" : "Add Instructor"}
              </Modal.Title>
            ...
            >
              <Modal.Body>
                ...
                <div className="mb-3">
                  <Form.Label>
                    Instructor Image<span className="text-danger">*</span>
                  </Form.Label>
                  <Dropzone
                  ...
                  <ul className="list-unstyled mb-0" id="course-preview">
                    {(selectfeils || [])?.map((f: any, i: number) => {
                      console.log("instructorgrid", f);

                      return (
                        <li
                          className="mt-2 "
                          id="course-preview-list"
                          key={i + "-file"}
                        >
                ...
                <Row>
                  <Col lg={12}>
                    <div className="mb-3">
                      <Form.Label htmlFor="instuctor-id-input">
                        Instructor ID
                      </Form.Label>
                      <Form.Control
                        type="text"
                        id="instuctor-id-input"
                        value="#TBSI159011"
                        disabled
                      />
                    </div>
                  ...
                  <Col lg={12}>
                    <div className="mb-3">
                      <Form.Label htmlFor="instructor-name-input">
                  ...
                  <Col lg={6}>
                    <div className="mb-3">
                      <Form.Label htmlFor="total-courses-input">
                        Total Courses<span className="text-danger">*</span>
                      </Form.Label>
                      <Form.Control
                        type="number"
                  ...
                  <Col lg={12}>
                    <div className="mb-3">
                      <Form.Label htmlFor="status-input">
              ...
              <Modal.Footer>
                <div className="hstack gap-2 justify-content-end">
                  <Button variant="ghost-danger" onClick={() => tog_modal()}>
