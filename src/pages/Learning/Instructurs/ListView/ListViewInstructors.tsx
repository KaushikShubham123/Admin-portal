...
const ListViewInstructor = () => {
  ...
  const handleSearch = (event: any) => {
    ...
    if (search) {
      ...
      setInstructor(
        instructorList.filter((data: any) =>
  ...
  const columns = useMemo(
    () => [
          ...
          return (
            <div className="d-flex gap-2 align-items-center">
              ...
              <div className="flex-grow-1">
                <Link to="/apps-instructors-overview" className="text-reset">
      ...
      },
      {
        ...
        accessor: "totalcourse",
        Filter: false,
        isSortable: true,
        Cell: (cell: any) => {
          return <span>{cell.row.original.totalcourse}</span>;
        },
      },
      {
        Header: "Email",
      ...
      },
      {
        ...
        isSortable: true,
        Cell: (cell: any) => {
          return <span>{cell.row.original.experience}</span>;
        },
      },
      {
        Header: "Students",
      ...
      },
      {
        ...
        Cell: (cell: any) => {
          return (
            <span>
              <i className="bi bi-star-fill text-warning align-baseline me-1"></i>{" "}
              <span className="rating-value"> {cell.row.original.rating}</span>
            </span>
          );
        },
      },
    ...
    <React.Fragment>
                ...
                <Card className="card-height-100">
                  <Card.Body className="text-center">
                    <div
                      ...
                      className="radialbar-chart-effect-primary"
                      dir="ltr"
                    >
                    ...
                    <p className="text-muted mb-0">
                      <span className="text-success">
                        <i className="ph ph-trend-up align-middle me-1"></i>{" "}
                        07.78%
                      </span>{" "}
                      than last week
                    </p>
              ...
              <Col xxl={2} sm={6}>
                <Card className="card-height-100">
                  <Card.Body className="text-center">
                    <div
                      id="total_courses"
                      className="radialbar-chart-effect-secondary"
                      dir="ltr"
                    >
                    ...
                    <p className="text-muted mb-0">
                      <span className="text-danger">
                        <i className="ph ph-trend-down align-middle me-1"></i>
                        01.39%
                      </span>{" "}
                      than last week
                    </p>
              ...
              <Col xxl={8}>
                <Card>
                  <Card.Header className="d-flex align-items-center">
                    <Card.Title as="h6" className="flex-grow-1 mb-0">
                      Instructor Activity
                    </Card.Title>
      ...
      <Modal show={addInstructors} onHide={handleAddClose}>
        <Modal.Header closeButton>
          <Modal.Title as="h5" id="addInstructorModalLabel">
            {editInstructors ? "Edit Instructor" : "Add Instructor"}
          </Modal.Title>
        </Modal.Header>
        <Form
        ...
        >
          <Modal.Body>
            <div className="mb-3">
              ...
              >
                {({ getRootProps }: any) => (
                  <div
                    className="dropzone instrucor-dropzone border border-1 border-dashed text-center"
            ...
            <Row>
              ...
              <Col lg={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="experience-input">
              ...
              <Col lg={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="rating-input">
          ...
          <Modal.Footer>
            <div className="hstack gap-2 justify-content-end">
              ...
              <Button type="submit" className="add-btn" variant="primary">
                {" "}
                {editInstructors ? "Edit Course" : "Add Course"}{" "}
              </Button>
            </div>
          </Modal.Footer>
        </Form>
