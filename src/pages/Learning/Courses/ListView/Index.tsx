    ...
    <React.Fragment>
                  ...
                  <Row className="align-items-center g-2">
                    <Col lg={3} className="me-auto">
                      <h6 className="card-title mb-0">
                        Instructors List{" "}
                        <span className="badge bg-primary ms-1 align-baseline">
                          1452
                        </span>
                      </h6>
                    </Col>
                    ...
                    <div className="col-lg-auto">
                      <div className="hstack flex-wrap gap-2">
                        ...
                        <div className="d-flex gap-1">
                          <Button variant="info" onClick={handleFilterShow}>
                            <i className="bi bi-funnel align-baseline me-1"></i>{" "}
                            Filter
                          </Button>
                          <Link
                          ...
                          <Link
                            ...
                            className="btn btn-subtle-primary active btn-icon"
                          >
      ...
      <Offcanvas show={courseFilters} placement="end" onHide={handleFilterShow}>
        ...
        <Offcanvas.Body>
          <Form>
            <Row>
              <Col lg={12}>
                <div className="mb-3">
                  <Form.Label className="select-category-filter fs-md mb-3 text-decoration-underline">
                    Price
                  </Form.Label>
                  <Nouislider
        ...
        <Offcanvas.Header className=" htsack gap-2 border-top">
          <Button className="btn btn-subtle-danger w-100">
            <i className="bi bi-x-lg align-baseline me-1"></i> Reset
          </Button>
          <Button variant="secondary" className="w-100">
            <i className="bi bi-funnel align-baseline me-1"></i> Filters
          </Button>
        </Offcanvas.Header>
      </Offcanvas>
      ...
      >
        <Modal.Header
          ...
          closeVariant="white"
        >
          <Modal.Title as="h5" className="text-white" id="addCourseModalLabel">
            Add Course
          </Modal.Title>
        </Modal.Header>
        <Form
        ...
        >
          <Modal.Body>
            ...
            <div className="mb-3">
              <Form.Label htmlFor="course-category-input">
            ...
            <Row>
              <Col lg={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="instructor-input">
