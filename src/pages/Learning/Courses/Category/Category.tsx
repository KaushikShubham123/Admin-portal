...
const Category = () => {
  document.title = "Category | Ramana - Admin & Dashboard Template";
  ...
  const currentdata = useMemo(
    () => categoryList.slice(indexOfFirst, indexOfLast),
    [categoryList, indexOfFirst, indexOfLast]
  );
            ...
            {(filterGrid || [])?.map((categoryData: any) => {
              return (
                <Col key={categoryData.id}>
                  <Card
                    className={
                      "card-animate text-center bg-" +
                      categoryData.cardColor +
                    ...
                    <Card.Body className="p-4">
                      <div className="avatar-md mx-auto mb-4">
                        <div className="avatar-title bg-white rounded">
                          <img
                            src={categoryData.logoImg?.preview}
                            alt=""
                            className="avatar-sm"
                          />
                        </div>
                      </div>
                      <Link to="/apps-learning-grid" className="stretched-link">
                        <h5 className="text-truncate">{categoryData.title}</h5>
                      </Link>
                      <p className="text-muted mb-0">
                        {categoryData.courseCount}+ Courses Available
                      </p>
                    </Card.Body>
                  </Card>
                </Col>
          ...
          >
            ...
            >
              <Modal.Body>
                            ...
                            <div className="d-flex flex-wrap gap-2 p-2">
                              ...
                              <div className="flex-shrink-0 ms-3">
                                <Button
                                  ...
                                  data-dz-remove
                                  size="sm"
                                  onClick={() => handleDeleteImg(file?.size)}
                                >
                                  Delete
                                </Button>
                              </div>
                ...
                <div className="mb-3">
                  <Form.Label htmlFor="category-title-input">
                ...
                <div className="mb-3">
                  <Form.Label htmlFor="Courses-input">
