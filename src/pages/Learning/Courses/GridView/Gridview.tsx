...
const Gridview = () => {
  document.title = "Gridview | Ramana - Admin & Dashboard Template";
  ...
  const currentdata = useMemo(
    () => coursegridList.slice(indexOfFirst, indexOfLast),
    [coursegridList, indexOfFirst, indexOfLast]
  );
  ...
  const searchTeamMember = (ele: any) => {
    ...
    if (search) {
      ...
      setCurrentpages(
        coursegridList.filter((data: any) =>
  ...
  const handleSelect = (ele: any) => {
    ...
    if (select) {
      setCurrentpages(
        coursegridList.filter(
          (data: any) => data?.status === select || select === "all"
        )
      );
      setPagination(false);
    } else {
                  ...
                  <Row className="align-items-center gy-3">
                    ...
                    <div className="col-lg-auto text-end">
                      <div className="d-flex gap-2">
                        ...
                        <Link
                          to="/apps-learning-grid"
                          className="active btn btn-subtle-primary btn-icon ms-auto"
                        >
                          <i className="bi bi-grid"></i>
                        </Link>
                        <Link
                          to="/apps-learning-list"
            ...
            {currentpages.map((GridViewdata: any, key: any) => (
              <Col key={key}>
                <Card className="overflow-hidden">
                  <Card.Body
                    className={`bg-${GridViewdata.badgeColor}-subtle text-center learning-widgets d-flex align-items-center justify-content-center`}
                  >
                    <img
                      src={GridViewdata.logoImg?.preview}
                      alt=""
                      className="avatar-lg"
                    />
                    <img
                  ...
                  <Card.Body>
                    <div className="d-flex mb-3 align-items-center">
                      ...
                      <div className="flex-shrink-0">
                        <Button
                          ...
                          size="sm"
                          className="btn custom-toggle active btn-icon"
                          onClick={(e) => handleToogleIcon(e.target)}
                        >
                    ...
                    <h6 className="text-truncate fs-md text-capitalize">
                      <Link to="/apps-learning-overview" className="text-reset">
                        {GridViewdata.cardTitle}
                      </Link>
                    </h6>
                    ...
                    <ul className="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                      <li>
                        <p className="text-muted mb-0">
                          <i className="bi bi-clock align-baseline text-secondary me-1"></i>
                          {GridViewdata.courseDuration}
                        </p>
                      </li>
                      <li>
                        <p className="text-muted mb-0">
                          <i className="ph ph-student align-middle text-secondary me-1"></i>{" "}
                          {GridViewdata.students}
                        </p>
                      </li>
                      <li>
                        <p className="text-muted mb-0">
                          <i className="ph ph-graduation-cap align-middle text-secondary me-1"></i>{" "}
                          {GridViewdata.lessons} Lessons
                        </p>
                      </li>
                    </ul>
                  </Card.Body>
                  <div className="card-body border-top hstack align-items-center gap-2">
                    ...
                    <Dropdown className="flex-shrink-0 curser-pointer">
                      <Dropdown.Toggle
                        type="button"
                        bsPrefix="btn-icon btn-secondary btn-sm"
                      >
                        <i className="bi bi-three-dots"></i>
                      </Dropdown.Toggle>
                      <Dropdown.Menu>
                        <li>
                          <Dropdown.Item href={"/apps-learning-overview"}>
                            <i className="bi bi-eye align-baseline me-1"></i>{" "}
                            Overview
                          </Dropdown.Item>
                        </li>
                        <li>
                        ...
                        <li>
                          <Dropdown.Item
                            onClick={() => handleDeleteShow(GridViewdata)}
                          >
            ...
            >
              <Modal.Body>
                ...
                <div className="mb-3">
                  ...
                  >
                    {({ getRootProps }: any) => (
                      <div
                        className="dropzone course-dropzone border border-1 border-dashed text-center dz-clickable"
                ...
                <div className="mb-3">
                  ...
                  >
                    ...
                    <option value="Laravel Development">
                      Laravel Development
                    </option>
                ...
                <Row>
                  <Col lg={12}>
                    <div className="mb-3">
                      <Form.Label htmlFor="Property-username-input">
                  ...
                  <Col lg={6}>
                    <div className="mb-3">
                      <Form.Label htmlFor="lessons-input">
                  ...
                  <Col lg={6}>
                    <div className="mb-3">
                      <Form.Label htmlFor="duration-input">
                        Duration Time<span className="text-danger">*</span>
                      </Form.Label>
                      <Flatpickr
                        className="form-control"
                        options={{
                        ...
                        onChange={(courseDuration: any) =>
                          formik.setFieldValue(
                            "courseDuration",
                            moment(courseDuration[0], "YYYY").fromNow()
                          )
                        }
                      />
              ...
              <Modal.Footer>
                <div className="hstack gap-2 justify-content-end">
                  <Button variant="ghost-danger" onClick={handleClose}>
