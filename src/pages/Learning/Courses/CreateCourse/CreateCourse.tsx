...
const CreateCourse = () => {
  document.title = "Create Course | Ramana - Admin & Dashboard Template";
                      ...
                      <Tab.Content>
                        <Tab.Pane eventKey="0" className="fade">
                          ...
                          <Row className="g-3 align-items-center">
                            ...
                            <Col lg={6}>
                              <div>
                                ...
                                <Form.Select id="course-category-input">
                                  ...
                                  <option value="Flask Development">
                                    Flask Development
                                  </option>
                            ...
                            <Col lg={6}>
                              <div>
                                <Form.Label htmlFor="lavel-input">
                                  Courses Level
                                  <span className="text-danger">*</span>
                                </Form.Label>
                            ...
                            <Col lg={6}>
                              <div>
                                <Form.Label htmlFor="language-input">
                            ...
                            <Col lg={4}>
                              <div>
                                <Form.Label htmlFor="discount-input">
                                  Discount price
                                  <span className="text-danger">*</span>
                                </Form.Label>
                                <InputGroup>
