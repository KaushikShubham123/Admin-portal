...
const MySubsciptions = () => {
  document.title = "My Subsciptions | Ramana - Admin & Dashboard Template";
  ...
  const handlesearchdata = (ele: any) => {
    ...
    if (search) {
      ...
      setSubscriptionTable(
        subscriptionsList.filter((data: any) =>
                  ...
                  <Row className="align-items-center g-3">
                    <Col xxl={3} lg={6} className="me-auto">
                      ...
                      <p className="text-muted mb-0">
                        Monthly:{" "}
                        <b className="text-primary-emphasis">$326.95</b> Yearly:{" "}
                        <b className="text-primary-emphasis">$1452.32</b>
                      </p>
                    </Col>
                    <Col xxl={3}>
