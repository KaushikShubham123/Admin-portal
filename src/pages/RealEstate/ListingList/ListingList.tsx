...
const ListingList = () => {
  document.title = "Listing List | Ramana - Admin & Dashboard Template";
  ...
  const columns = useMemo(
    () => [
      {
        Header: <Form.Check type="checkbox" id="checkAll" />,
        accessor: (cell: any) => {
          return (
            <Form.Check>
      ...
      },
      {
        ...
        accessor: "bedroom",
        Cell: (cell: any) => {
          return <span>{cell.row.original.bedroom}</span>;
        },
        Filter: false,
        isSortable: true,
      },
      {
        ...
        accessor: "type",
        Cell: (cell: any) => {
          return <span>{cell.row.original.type}</span>;
        },
        Filter: false,
        isSortable: true,
      },
      {
        ...
        accessor: "area",
        Cell: (cell: any) => {
          return <span>{cell.row.original.area}</span>;
        },
        Filter: false,
        isSortable: true,
      },
      {
        ...
        accessor: "agent",
        Cell: (cell: any) => {
          return <span>{cell.row.original.agent}</span>;
        },
        Filter: false,
        isSortable: true,
      },
              ...
              return (
                <Col className="col" key={item.id}>
                  ...
                  >
                    <Card.Body>
                      <Badge
                        className={`bg-${item.iconColor}-subtle text-${item.iconColor} float-end`}
                      >
                        <i className={`${item.icon} align-middle me-1`}></i>{" "}
                        3.8%
                      </Badge>
                      <h4 className="mb-4">
                        <span className="counter-value">{item.target}</span>
                      </h4>
        ...
        <Form autoComplete="off" onSubmit={formik.handleSubmit}>
          <Modal.Body>
            ...
            <Row>
              ...
              <Col lg={4}>
                <div className="mb-3">
                  <Form.Label htmlFor="requirement-input">
