            ...
            <Col xxl={9}>
              <Card>
                <Card.Header className="d-flex align-items-center gap-2">
                  <Card.Title as="h5" className="flex-grow-1 mb-0">
                    Property Overview
                  </Card.Title>
                  <div className="flex-shrink-0 d-flex gap-1">
                    <Button
                      type="button"
                      size="sm"
                      className="btn btn-subtle-secondary"
                    >
                      ALL
                    </Button>
                    ...
                    <Card.Body>
                      <div className="d-flex align-items-center mb-4">
                        <div className="flex-grow-1">
                          <Button
                            type="button"
                            size="sm"
                            className="btn btn-subtle-warning custom-toggle btn-icon"
                            data-bs-toggle="button"
                            onClick={(e: any) => handleStar(e.target)}
                          >
                      ...
                      <div className="text-center">
                        <img
                          src={avatar1}
                          alt=""
                          className="avatar-md rounded mx-auto d-block"
                        />
                        <h5 className="mt-3">
                          Jerry Emard{" "}
                  ...
                  <Card className="overflow-hidden">
                    <Card.Header className="align-items-center d-flex bg-primary-subtle text-primary p-3">
                      <div className="flex-grow-1">
                        <Card.Title
                          as="h5"
                          className="text-primary-emphasis profile-username"
                        >
                          Jerry Emard
                        </Card.Title>
