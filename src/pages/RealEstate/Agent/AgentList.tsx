...
const AgentList = () => {
  document.title = "Agent List | Ramana - Admin & Dashboard Template";

  const dispatch = useDispatch<any>();

  const selectAgentListView = createSelector(
    (state: any) => state.RealEstate.agentlist,
    (agentListView) => agentListView
  );

  const { agentListView } = useSelector((state: any) => ({
    agentListView: selectAgentListView(state),
  }));
    ...
    () => [
      ...
      },
      {
        ...
        Cell: (cell: any) => {
          return (
            <Link
              to="/apps-real-estate-agent-overview"
            ...
            <ul className="d-flex gap-2 list-unstyled mb-0">
              ...
              <li>
                <Link
                  ...
                  onClick={() => handleShowEditAgent(cell)}
                >
      ...
      <Modal show={addagent} onHide={handleCloseAgent}>
        ...
        >
          <Modal.Body>
            <div className="mb-3">
              <Form.Label>
                Agent Images<span className="text-danger">*</span>
              </Form.Label>
              <Dropzone
              ...
              >
                {({ getRootProps }: any) => (
                  <div
                    className="sellers-dropzone text-center dz-clickable"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="address-input">
