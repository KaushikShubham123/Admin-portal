...
import {
  getRealEstateGridList as onGetRealEstateGridList,
  addRealEstateGridList as onAddRealEstateGridList,
} from "slices/realestate/thunk";
import { ToastContainer } from "react-toastify";
import { createSelector } from "reselect";

const ListingGrid = () => {
  document.title = "Listing Grid | Ramana - Admin & Dashboard Template";
                ...
                <Card.Body>
                  <Row className="align-items-center gy-3">
                    ...
                    <div className="col-sm-auto ms-auto d-flex gap-1">
                      <Button variant="secondary" onClick={handleShowProperty}>
        ...
        <Form onSubmit={formik.handleSubmit}>
          <Modal.Body>
            ...
            <Row>
              ...
              <Col lg={4}>
                <div className="mb-3">
                  <Form.Label htmlFor="property-location-input">
              ...
              <Col lg={4}>
                <div className="mb-3">
                  <Form.Label htmlFor="property-rating-input">
