...
const AgenciesList = () => {
  document.title = "List View | Ramana - Admin & Dashboard Template";
    ...
    () => [
      {
        ...
        id: "#",
        accessor: (cell: any) => {
          return <Form.Check type="checkbox" className="orderCheckBox" />;
        },
      },
      {
        Header: "#",
      ...
      },
      {
        ...
        isSortable: true,
        Cell: (cell: any) => {
          return <span>#TBS25000{cell.row.original.since}</span>;
        },
      },
      {
        Header: "Agencies Name",
        accessor: "Agencies Name",
        Filter: false,
        isSortable: true,
        Cell: (cell: any) => {
          return (
            <div className="d-flex align-items-center gap-2">
              <img
                src={cell.row.original.img?.priview}
                alt=""
                className="avatar-xxs rounded"
              />
              <Link to="#" className="text-reset text-capitalize">
      ...
      },
      {
        ...
        isSortable: true,
        Cell: (cell: any) => {
          return <span>{cell.row.original.location}</span>;
        },
      },
      {
        Header: "Total Property",
        accessor: "Total Property",
        Filter: false,
        isSortable: true,
        Cell: (cell: any) => {
          return <span>{cell.row.original.property}</span>;
        },
      },
      {
        Header: "Employee",
        ...
        isSortable: true,
        Cell: (cell: any) => {
          return <span>{cell.row.original.employee}</span>;
        },
      },
      {
        Header: "Email",
        ...
        isSortable: true,
        Cell: (cell: any) => {
          return <span>{cell.row.original.email}</span>;
        },
      },
      {
        Header: "Contacts",
        ...
        isSortable: true,
        Cell: (cell: any) => {
          return <span>{cell.row.original.contact}</span>;
        },
      },
      {
        Header: "Action",
            ...
            <ul className="d-flex gap-2 list-unstyled mb-0">
              ...
              <li>
                <Link
                  ...
                  onClick={() => handleShowEditAgencies(cell)}
                >
  ...
  const formik: any = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string()
        .email()
        .matches(/^(?!.*@[^,]*,)/)
        .required("Please Enter Your Agent Email"),
    ...
    <React.Fragment>
                      ...
                      <Row className="align-items-center g-2">
                        <Col className="col-sm-auto">
                          <Dropdown className="dropdown card-header-dropdown sortble-dropdown cursor-pointer">
                            ...
                            <Dropdown.Menu className="dropdown-menu-end">
                              <Dropdown.Item
                                className="sort"
                                onClick={() => setSortDrop("Since")}
                              >
                                Since
                              </Dropdown.Item>
                              <Dropdown.Item
                                className="sort"
                                onClick={() => setSortDrop("Agencies name")}
                              >
                                Agencies name
                              </Dropdown.Item>
                              <Dropdown.Item
                                className="sort"
                                onClick={() => setSortDrop("Address")}
                              >
                                Address
                              </Dropdown.Item>
                              <Dropdown.Item
                                className="sort"
                                onClick={() => setSortDrop("Total Property")}
                              >
                                Total Property
                              </Dropdown.Item>
                              <Dropdown.Item
                                className="sort"
                                onClick={() => setSortDrop("Employee")}
                              >
                                Employee
                              </Dropdown.Item>
                              <Dropdown.Item
                                className="sort"
                                onClick={() => setSortDrop("Email")}
                              >
                                Email
                              </Dropdown.Item>
                              <Dropdown.Item
                                className="sort"
                                onClick={() => setSortDrop("Contacts")}
                              >
                                Contacts
                              </Dropdown.Item>
                            </Dropdown.Menu>
                        ...
                        <Col className="col-sm-auto ms-auto">
                          <div className="d-flex gap-2">
                            <Button
                              className="btn btn-subtle-danger d-none order-2 order-sm-1"
                              id="remove-actions"
                            >
                    ...
                    <div className="noresult">
                      <div className="text-center py-4">
                        ...
                        <p className="text-muted mb-0">
                          We've searched more than 150+ products We did not find
                          any products for you search.
                        </p>
                      </div>
                    </div>
                  )}
      ...
      <Modal show={addagencies} onHide={handleCloseAgencies}>
        <Modal.Header closeButton>
          <Modal.Title as="h5" id="addAgencyModalLabel">
            {editagencies ? "Edit Agencies" : "Add Agencies"}
          </Modal.Title>
        </Modal.Header>
        <Form
        ...
        >
          <Modal.Body>
            <div className="mb-3">
              <Form.Label>
                Agencies Images<span className="text-danger">*</span>
              </Form.Label>
              <Dropzone
              ...
              >
                {({ getRootProps }: any) => (
                  <div
                    className="border border-1 border-dashed text-center dz-clickable"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="agencies-name-input">
                Agencies Name<span className="text-danger">*</span>
              </Form.Label>
              <Form.Control
                type="text"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="since-input">
            ...
            <Row>
              <Col lg={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="property-input">
                    Total Property<span className="text-danger">*</span>
                  </Form.Label>
                  <Form.Control
                    type="number"
                    id="property"
              ...
              <Col lg={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="employee-input">
            ...
            <div>
              <Form.Label htmlFor="address-input" className="form-label">
