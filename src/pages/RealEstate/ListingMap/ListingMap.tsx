...
import {
  deleteRealestateListMap as onDeleteRealestateListMap,
  addRealEstateListMap as onAddRealEstateListMap,
  updateRealEstateListMap as onUpdateRealEstateListMap,
  getRealestateListMap as onGetRealestateListMap,
} from "slices/thunk";
...
const ListingMap = () => {
  document.title = "Listing Map | Ramana - Admin & Dashboard Template";
  ...
  const currentdata = useMemo(
    () => listmap.slice(indexOfFirst, indexOfLast),
    [listmap, indexOfFirst, indexOfLast]
  );
  useEffect(() => {
                  ...
                  <Row className="g-3">
                    ...
                    <Col sm={6} className="col-xl">
                      <Form.Select
                        className="form-control"
                        id="idBedroom"
                        onChange={(e: any) => handlebedroom(e)}
                      >
                ...
                <Col xl={5}>
                  <Card.Header>
                    <div className="d-flex align-items-center flex-wrap gap-2 text-muted">
                      ...
                      <Link to="#" className="badge border text-reset">
                        $2000-$3000
                      </Link>
                      <div className="vr"></div>
                      <Link to="#" className="badge border text-reset">
                          ...
                          <Col lg={5}>
                            <div className="position-relative">
                              <img
                                ...
                                style={{ width: 259, height: 159 }}
                              />
                              <div className="position-absolute bottom-0 start-0 m-2">
                                {item.type === "Villa" ? (
                                  <Badge
                                    bg="white"
                                    className="text-danger fs-xxs"
                                  >
                            ...
                            <div className="d-flex flex-column h-100">
                              <div>
                                <Dropdown className="float-end">
                                  <Dropdown.Toggle
                                    bsPrefix="btn-light btn btn-icon btn-sm"
                                    type="button"
                                  >
                                  ...
                                  <Dropdown.Menu className="dropdown-menu-end">
                                    ...
                                    <Dropdown.Item
                                      href="#"
                                      onClick={() =>
                                        handleShowDeleteProperty(item.id)
                                      }
                                    >
                                ...
                                <h6 className="fs-lg text-capitalize text-truncate">
                                  <Link
                                    to="/apps-real-estate-property-overview"
          ...
          <Modal.Body>
            <div className="mb-3">
              ...
              >
                {({ getRootProps }: any) => (
                  <div
                    className="dropzone property-dropzone border border-1 border-dashed text-center dz-clickable"
            ...
            <div className="mb-3">
              <Form.Label htmlFor="Property-title-input">
            ...
            <div className="mb-3">
              <Form.Label htmlFor="Property-type-input">
            ...
            <Row>
              <Col lg={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="bedroom-input">
              ...
              <Col lg={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="bathroom-input">
              ...
              <Col lg={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="Property-price-input">
              ...
              <Col lg={12}>
                <div className="mb-3">
                  <Form.Label htmlFor="addressLine">
                    Sort Address<span className="text-danger">*</span>
                  </Form.Label>
                  <Form.Control
                    as="textarea"
                    id="addressLine"
