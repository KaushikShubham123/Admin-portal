...
const Calendar = () => {
  document.title = "Calendar | Ramana Admin & Dashboard Template";
  ...
  useEffect(() => {
    ...
    const externalEvents = document.getElementById(
      "external-events"
    ) as HTMLElement;
          ...
          <div className="calendar-wrapper d-xl-flex gap-4">
            ...
            <Card className="mb-0 calendar-event-card">
              <Card.Body>
                ...
                <UpcommingEvents categories={categories} onDrag={onDrag} />
              </Card.Body>
            </Card>
          </div>
        </Container>
          ...
          >
            {!!isEdit ? (
              <div className="text-end">
                <Link
                  to="#"
                  className="btn btn-sm btn-subtle-primary d-inline"
                  id="edit-event-btn"
                  onClick={(e) => {
                    e.preventDefault();
                    submitOtherEvent();
                ...
                <Link
                  to="#"
                  className="btn btn-sm btn-subtle-primary d-none"
                  id="cancel-event-btn"
              ...
              {!!isEdit && (
                <>
                  <Col xs={6} className={!!isEdit ? "d-none" : ""}>
                    <div className="mb-3">
                      <Form.Label className={!!isEdit ? "d-none" : ""}>
                        Start Time
                      </Form.Label>
                      <div
                        className={
