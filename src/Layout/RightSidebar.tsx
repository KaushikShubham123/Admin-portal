  ...
  return (
    <React.Fragment>
      ...
      <div className="customizer-setting d-none d-md-block">
        <div
          className="btn btn-info p-2 text-uppercase rounded-end-0 shadow-lg"
      ...
      >
        <Offcanvas.Header className="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
          <div className="me-2">
            <h5 className="mb-1 text-white">Ramana Builder</h5>
            ...
            <div className="p-4">
              ...
              <Row>
                ...
                <div className="col-4">
                  ...
                  <h5 className="fs-sm text-center fw-medium mt-2">
                    Horizontal
                  </h5>
                </div>
                <div className="col-4">
                ...
                <Col xs={6}>
                  <div className="form-check card-radio">
                    <input
                      ...
                      checked={
                        layoutThemeType === LAYOUT_THEME_TYPES.INTERACTION
                      }
                      onChange={(e) => {
                        if (e.target.checked) {
                          dispatch(changeLayoutTheme(e.target.value));
                ...
                <Row className="g-3">
                  <Col xs={6}>
                    <div className="form-check card-radio">
                      ...
                      />
                      <label
                        className="form-check-label p-0 bg-transparent"
                  ...
                  <Col xs={6}>
                    <div className="form-check card-radio brand">
                      <input
                        ...
                        disabled
                      />
                      <h6 className="text-danger fs-xl lh-base text-center position-absolute top-50 start-50 translate-middle z-1 mb-0">
                        Coming Soon
                      </h6>
                      <label
                        className="form-check-label cursor-none p-0 bg-transparent opacity-75"
                        htmlFor="layout-mode-brand"
                      >
