...
export const PATCH_UPDATE_COMPANY_PROFILE= "/existedcompanydetailsupdate";
export const POST_CREATE_NEW_PASSWORD = "/reset";
export const POST_FAKE_JWT_LOGIN = "/post-jwt-login";
export const POST_PASSWORD_FORGET = "/forgetpassword";
...
//sellers
export const GET_SELLERTS = "/getsubvendors";
export const ADD_NEW_SELLERTS = "/addsubvendor";
export const UPDATE_SELLERTS = "/addsubvendor";
