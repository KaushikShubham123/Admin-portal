...
// postForgetPwd
export const postFakeJwtForgetPwd = (data: any) => api.create(url.POST_FAKE_JWT_PASSWORD_FORGET, data);
...
export const updateSellers = (data: any) => api.create(url.UPDATE_SELLERTS, data);
